...
public class ReplyAllItem extends MessageResponse
{
    public ReplyAllItem() {
    }
    
    public ReplyAllItem(final ItemId referenceItemId) {
        this.aw = referenceItemId;
    }
    
    ReplyAllItem(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ReplyAllToItem") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
