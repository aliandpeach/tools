...
public class RuleExceptions
{
    ...
    RuleExceptions(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        this.a = new ArrayList<String>();
        this.b = new ArrayList<String>();
        this.c = new ArrayList<String>();
        this.d = new ArrayList<String>();
    ...
    private void a(final XMLStreamReader xmlStreamReader) throws XMLStreamException, ParseException {
        while (xmlStreamReader.hasNext()) {
            if (xmlStreamReader.isStartElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("Categories") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                this.h = com.ews.exchange.a.g(xmlStreamReader.getElementText());
            }
                ...
                if ((elementText2 = xmlStreamReader.getElementText()) != null && elementText2.length() > 0) {
                    this.l = com.ews.exchange.a.O(elementText2);
                }
            }
                ...
                if ((elementText19 = xmlStreamReader.getElementText()) != null && elementText19.length() > 0) {
                    this.F = com.ews.exchange.a.N(elementText19);
                }
            }
            ...
            if (xmlStreamReader.isEndElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("Exceptions") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            xmlStreamReader.next();
        }
    ...
    final String a() {
        String s = "<t:Exceptions>";
        if (this.a != null && this.a.size() > 0) {
            String s2 = s + "<t:Categories>";
            for (int i = 0; i < this.a.size(); ++i) {
                if (this.a.get(i) != null) {
                    s2 = s2 + "<t:String>" + com.ews.exchange.d.a(this.a.get(i)) + "</t:String>";
                }
            }
            s = s2 + "</t:Categories>";
        }
        if (this.b != null && this.b.size() > 0) {
            ...
            for (int j = 0; j < this.b.size(); ++j) {
                if (this.b.get(j) != null) {
                    s3 = s3 + "<t:String>" + com.ews.exchange.d.a(this.b.get(j)) + "</t:String>";
                }
            }
        ...
        if (this.c != null && this.c.size() > 0) {
            ...
            for (int k = 0; k < this.c.size(); ++k) {
                if (this.c.get(k) != null) {
                    s4 = s4 + "<t:String>" + com.ews.exchange.d.a(this.c.get(k)) + "</t:String>";
                }
            }
        ...
        if (this.d != null && this.d.size() > 0) {
            ...
            for (int l = 0; l < this.d.size(); ++l) {
                if (this.d.get(l) != null) {
                    s5 = s5 + "<t:String>" + com.ews.exchange.d.a(this.d.get(l)) + "</t:String>";
                }
            }
        ...
        if (this.e != null && this.e.size() > 0) {
            ...
            for (int n = 0; n < this.e.size(); ++n) {
                if (this.e.get(n) != null) {
                    s6 = s6 + "<t:String>" + com.ews.exchange.d.a(this.e.get(n)) + "</t:String>";
                }
            }
        ...
        if (this.f != null && this.f.size() > 0) {
            ...
            for (int n2 = 0; n2 < this.f.size(); ++n2) {
                if (this.f.get(n2) != null) {
                    s7 = s7 + "<t:String>" + com.ews.exchange.d.a(this.f.get(n2)) + "</t:String>";
                }
            }
        ...
        if (this.g != null && this.g.size() > 0) {
            ...
            for (int n3 = 0; n3 < this.g.size(); ++n3) {
                if (this.g.get(n3) != null) {
                    s8 = s8 + "<t:String>" + com.ews.exchange.d.a(this.g.get(n3)) + "</t:String>";
                }
            }
            s = s8 + "</t:ContainsSubjectStrings>";
        }
        if (this.h != FlaggedForAction.NONE) {
            s = s + "<t:FlaggedForAction>" + com.ews.exchange.a.a(this.h) + "</t:FlaggedForAction>";
        }
        if (this.i.size() > 0) {
        ...
        if (this.j != null && this.j.size() > 0) {
            ...
            for (int n5 = 0; n5 < this.j.size(); ++n5) {
                if (this.j.get(n5) != null) {
                    s10 = s10 + "<t:String>" + com.ews.exchange.d.a(this.j.get(n5)) + "</t:String>";
                }
            }
        ...
        if (this.l != Importance.NONE) {
            s = s + "<t:Importance>" + com.ews.exchange.a.a(this.l) + "</t:Importance>";
        }
        if (this.m) {
        ...
        if (this.x != null && this.x.size() > 0) {
            ...
            for (int n6 = 0; n6 < this.x.size(); ++n6) {
                if (this.x.get(n6) != null) {
                    s11 = s11 + "<t:String>" + com.ews.exchange.d.a(this.x.get(n6)) + "</t:String>";
                }
            }
            s = s11 + "</t:ItemClasses>";
        }
        if (this.y != null && this.y.size() > 0) {
            ...
            for (int n7 = 0; n7 < this.y.size(); ++n7) {
                if (this.y.get(n7) != null) {
                    s12 = s12 + "<t:String>" + com.ews.exchange.d.a(this.y.get(n7)) + "</t:String>";
                }
            }
