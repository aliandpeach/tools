...
public class Flag
{
        ...
        while (true) {
            if (xmlStreamReader.isStartElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("FlagStatus") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText = xmlStreamReader.getElementText()) != null && elementText.length() > 0) {
                    this.a = com.ews.exchange.a.K(elementText);
                }
            }
                ...
                this.b = com.ews.exchange.d.c(xmlStreamReader.getElementText());
            }
                ...
                this.c = com.ews.exchange.d.c(xmlStreamReader.getElementText());
            }
                ...
                this.d = com.ews.exchange.d.c(xmlStreamReader.getElementText());
            }
    ...
    final String a() {
        ...
        if (this.b != null) {
            s = s + "<t:StartDate>" + com.ews.exchange.d.a(this.b) + "</t:StartDate>";
        }
        if (this.c != null) {
            s = s + "<t:DueDate>" + com.ews.exchange.d.a(this.c) + "</t:DueDate>";
        }
        if (this.d != null) {
            s = s + "<t:CompleteDate>" + com.ews.exchange.d.a(this.d) + "</t:CompleteDate>";
        }
        return s + "</t:Flag>";
    }
