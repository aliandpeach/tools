...
public class Appointment extends Item
{
    ...
    private void a(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ItemId") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                this.am = com.ews.exchange.d.c(reader.getElementText());
            }
                ...
                this.an = com.ews.exchange.d.c(reader.getElementText());
            }
                ...
                this.ao = com.ews.exchange.d.c(reader.getElementText());
            }
                ...
                if ((elementText9 = reader.getElementText()) != null && elementText9.length() > 0) {
                    this.aq = com.ews.exchange.d.c(elementText9);
                }
            }
                ...
                if ((elementText10 = reader.getElementText()) != null && elementText10.length() > 0) {
                    this.ar = com.ews.exchange.d.c(elementText10);
                }
            }
                ...
                if ((elementText11 = reader.getElementText()) != null && elementText11.length() > 0) {
                    this.as = com.ews.exchange.d.c(elementText11);
                }
            }
                ...
                if ((elementText12 = reader.getElementText()) != null && elementText12.length() > 0) {
                    this.at = com.ews.exchange.d.c(elementText12);
                }
            }
                ...
                if ((elementText13 = reader.getElementText()) != null && elementText13.length() > 0) {
                    this.au = com.ews.exchange.d.c(elementText13);
                }
            }
                ...
                if ((elementText15 = reader.getElementText()) != null && elementText15.length() > 0) {
                    this.aw = com.ews.exchange.a.I(elementText15);
                }
            }
                ...
                if ((elementText21 = reader.getElementText()) != null && elementText21.length() > 0) {
                    this.aE = com.ews.exchange.a.z(elementText21);
                }
            }
                ...
                if ((elementText22 = reader.getElementText()) != null && elementText22.length() > 0) {
                    this.aF = com.ews.exchange.a.B(elementText22);
                }
            }
                ...
                if ((elementText25 = reader.getElementText()) != null && elementText25.length() > 0) {
                    this.aQ = com.ews.exchange.d.c(elementText25);
                }
            }
                ...
                if ((elementText32 = reader.getElementText()) != null && elementText32.length() > 0) {
                    this.s = com.ews.exchange.d.c(elementText32);
                }
            }
                ...
                if ((elementText33 = reader.getElementText()) != null && elementText33.length() > 0) {
                    this.N = com.ews.exchange.a.C(elementText33);
                }
            }
                ...
                if ((elementText34 = reader.getElementText()) != null && elementText34.length() > 0) {
                    this.O = com.ews.exchange.a.C(elementText34);
                }
            }
                ...
                if ((elementText37 = reader.getElementText()) != null && elementText37.length() > 0) {
                    this.S = com.ews.exchange.a.D(elementText37);
                }
            }
                ...
                if ((extendedProperty = new ExtendedProperty(reader)).getPropertyPath() instanceof PropertyTag) {
                    ...
                    if ((propertyTag = (PropertyTag)extendedProperty.getPropertyPath()).getTag() == MapiPropertyTag.PR_DISPLAY_NAME.getTag() && propertyTag.getType() == MapiPropertyTag.PR_DISPLAY_NAME.getType()) {
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.bw = com.ews.exchange.a.M(extendedProperty.getValue());
                        }
                    }
                    else {
                        final String value2;
                        if (propertyTag.getTag() == MapiPropertyTag.PR_RTF_COMPRESSED.getTag() && propertyTag.getType() == MapiPropertyTag.PR_RTF_COMPRESSED.getType() && (value2 = extendedProperty.getValue()) != null && value2.length() > 0) {
                            this.D = com.ews.exchange.d.e(value2);
                        }
                    }
                }
                    ...
                    if ((propertyId = (PropertyId)extendedProperty.getPropertyPath()).getId() == 34054 && propertyId.getSet() == StandardPropertySet.COMMON && propertyId.getType() == MapiPropertyType.BOOLEAN) {
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.bn = com.ews.exchange.d.c(extendedProperty.getValue());
                        }
                    }
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.bo = com.ews.exchange.d.c(extendedProperty.getValue());
                        }
                    }
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.bk = com.ews.exchange.a.A(extendedProperty.getValue());
                        }
                    }
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.bm = com.ews.exchange.a.G(extendedProperty.getValue());
                        }
                    }
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.bl = com.ews.exchange.a.H(extendedProperty.getValue());
                        }
                    }
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.bu = com.ews.exchange.d.c(extendedProperty.getValue());
                        }
                    }
                        ...
                        this.bv = com.ews.exchange.d.c(extendedProperty.getValue());
                    }
                }
    ...
    final String a() {
        ...
        if (this.E != null && this.aY == null) {
            s = s + "<t:ReminderDueBy>" + com.ews.exchange.d.a(this.E) + "</t:ReminderDueBy>";
        }
        else if (this.E != null) {
            s = s + "<t:ReminderDueBy>" + com.ews.exchange.d.a(this.E) + "</t:ReminderDueBy>";
        }
        ...
        if (this.bk != BusyStatus.NONE) {
            s3 += new ExtendedProperty(AppointmentPropertyPath.BUSY_STATUS, com.ews.exchange.a.a(this.bk)).toString();
        }
        if (this.bl != MeetingStatus.NONE) {
            s3 += new ExtendedProperty(AppointmentPropertyPath.MEETING_STATUS, com.ews.exchange.a.a(this.bl)).toString();
        }
        if (this.bm != ResponseStatus.NONE) {
            s3 += new ExtendedProperty(AppointmentPropertyPath.RESPONSE_STATUS, com.ews.exchange.a.a(this.bm)).toString();
        }
        if (this.bn != null) {
        ...
        if (this.br != null) {
            s3 += new ExtendedProperty(AppointmentPropertyPath.REMINDER_SOUND_FILE, com.ews.exchange.d.a(this.br)).toString();
        }
        if (this.bs >= 0) {
            s3 += new ExtendedProperty(AppointmentPropertyPath.LABEL, this.bs).toString();
        }
        if (this.bt != null) {
            s3 += new ExtendedProperty(AppointmentPropertyPath.RECURRENCE_PATTERN, com.ews.exchange.d.a(this.bt)).toString();
        }
        if (this.bu != null) {
        ...
        if (this.D != null && this.D.length > 0) {
            s3 += new ExtendedProperty(MapiPropertyTag.PR_RTF_COMPRESSED, com.ews.exchange.d.a(this.D)).toString();
        }
        ...
        if (this.L != null) {
            s3 = s3 + "<t:RetentionDate>" + com.ews.exchange.d.a(this.L) + "</t:RetentionDate>";
        }
        if (this.ap != null) {
            s3 = s3 + "<t:UID>" + com.ews.exchange.d.a(this.ap) + "</t:UID>";
        }
        if (this.am != null) {
            s3 = s3 + "<t:ReminderNextTime>" + com.ews.exchange.d.a(this.am) + "</t:ReminderNextTime>";
        }
        if (this.as != null && this.aY == null) {
            s3 = s3 + "<t:Start>" + com.ews.exchange.d.a(this.as) + "</t:Start>";
        }
        else if (this.as != null) {
            s3 = s3 + "<t:Start>" + com.ews.exchange.d.a(this.as) + "</t:Start>";
        }
        if (this.at != null && this.aY == null) {
            s3 = s3 + "<t:End>" + com.ews.exchange.d.a(this.at) + "</t:End>";
        }
        ...
        if (this.aw != LegacyFreeBusy.NONE) {
            s3 = s3 + "<t:LegacyFreeBusyStatus>" + com.ews.exchange.a.a(this.aw) + "</t:LegacyFreeBusyStatus>";
        }
        if (this.ax != null) {
            s3 = s3 + "<t:Location>" + com.ews.exchange.d.a(this.ax) + "</t:Location>";
        }
        if (this.ay != null) {
            s3 = s3 + "<t:When>" + com.ews.exchange.d.a(this.ay) + "</t:When>";
        }
        String s4;
        if (this.aD) {
        ...
        if (this.be != null) {
            s4 = s4 + "<t:MeetingWorkspaceUrl>" + com.ews.exchange.d.a(this.be) + "</t:MeetingWorkspaceUrl>";
        }
        if (this.bf != null) {
            s4 = s4 + "<t:NetShowUrl>" + com.ews.exchange.d.a(this.bf) + "</t:NetShowUrl>";
        }
        if (this.bh != null) {
            s4 = s4 + "<t:JoinOnlineMeetingUrl>" + com.ews.exchange.d.a(this.bh) + "</t:JoinOnlineMeetingUrl>";
        }
        if (this.bi != null) {
            s4 += this.bi.a();
        }
