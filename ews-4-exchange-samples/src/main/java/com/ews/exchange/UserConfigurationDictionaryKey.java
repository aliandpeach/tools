...
public class UserConfigurationDictionaryKey
{
    ...
    public UserConfigurationDictionaryKey(final UserConfigurationDictionaryObjectType type, final String value) {
        this.a = UserConfigurationDictionaryObjectType.STRING;
        this.b = new ArrayList<String>();
        this.a = type;
        this.b.add(value);
    ...
    public UserConfigurationDictionaryKey(final UserConfigurationDictionaryObjectType type, final List<String> values) {
        this.a = UserConfigurationDictionaryObjectType.STRING;
        this.b = new ArrayList<String>();
        this.a = type;
        if (values != null) {
    ...
    UserConfigurationDictionaryKey(final XMLStreamReader reader) throws XMLStreamException {
        this.a = UserConfigurationDictionaryObjectType.STRING;
        this.b = new ArrayList<String>();
        this.a(reader);
    }
        ...
        while (xmlStreamReader.hasNext()) {
            if (xmlStreamReader.isStartElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("Type") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText = xmlStreamReader.getElementText()) != null && elementText.length() > 0) {
                    this.a = com.ews.exchange.a.d(elementText);
                }
            }
    ...
    final String a() {
        String s = "<t:DictionaryKey>" + "<t:Type>" + com.ews.exchange.a.a(this.a) + "</t:Type>";
        for (int i = 0; i < this.b.size(); ++i) {
            if (this.b.get(i) != null) {
                s = s + "<t:Value>" + d.a(this.b.get(i)) + "</t:Value>";
            }
        }
        return s + "</t:DictionaryKey>";
    }
