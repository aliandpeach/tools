        ...
        while (reader.hasNext()) {
            if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ExtendedFieldURI") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if (attributeValue != null) {
                    this.a = new PropertyTag(Integer.parseInt(attributeValue.replace("0x", ""), 16), com.ews.exchange.a.F(attributeValue6));
                }
                else if (attributeValue2 != null) {
                    if (attributeValue4 != null) {
                        this.a = new PropertyName(attributeValue4, com.ews.exchange.a.E(attributeValue2), com.ews.exchange.a.F(attributeValue6));
                    }
                    else {
                        this.a = new PropertyId(Integer.parseInt(attributeValue5), com.ews.exchange.a.E(attributeValue2), com.ews.exchange.a.F(attributeValue6));
                    }
                }
                else if (attributeValue3 != null) {
                    if (attributeValue4 != null) {
                        this.a = new CustomPropertyName(attributeValue4, attributeValue3, com.ews.exchange.a.F(attributeValue6));
                    }
                    else {
                        this.a = new CustomPropertyId(Integer.parseInt(attributeValue5), attributeValue3, com.ews.exchange.a.F(attributeValue6));
                    }
                }
            }
