...
public class ForwardItem extends MessageResponse
{
    public ForwardItem() {
    }
    
    public ForwardItem(final ItemId referenceItemId) {
        this.aw = referenceItemId;
    }
    
    ForwardItem(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ForwardItem") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
