...
public class ContactsFolder extends Folder
{
    ...
    public ContactsFolder(final String displayName) {
        this.d = displayName;
    }
    
    public ContactsFolder(final String displayName, final String folderClass) {
        this.d = displayName;
        this.c = folderClass;
    }
    
    ContactsFolder(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ContactsFolder") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
