...
public class Category
{
    ...
    Category(final XMLStreamReader reader) throws ParseException {
        ...
        if (attributeValue4 != null && attributeValue4.length() > 0) {
            this.e = com.ews.exchange.d.c(attributeValue4);
        }
        if (attributeValue5 != null && attributeValue5.length() > 0) {
            this.f = com.ews.exchange.d.c(attributeValue5);
        }
        if (attributeValue6 != null && attributeValue6.length() > 0) {
            this.g = com.ews.exchange.d.c(attributeValue6);
        }
        if (attributeValue7 != null && attributeValue7.length() > 0) {
            this.h = com.ews.exchange.d.c(attributeValue7);
        }
        if (attributeValue8 != null && attributeValue8.length() > 0) {
            this.i = com.ews.exchange.d.c(attributeValue8);
        }
        if (attributeValue9 != null && attributeValue9.length() > 0) {
            this.j = com.ews.exchange.d.c(attributeValue9);
        }
        if (attributeValue10 != null && attributeValue10.length() > 0) {
            this.k = com.ews.exchange.d.c(attributeValue10);
        }
    ...
    final String a() {
        ...
        if (this.a != null) {
            string = string + " name=\"" + com.ews.exchange.d.a(this.a) + "\"";
        }
        ...
        if (this.e != null) {
            s = s + " lastTimeUsedNotes=\"" + com.ews.exchange.d.a(this.e) + "\"";
        }
        if (this.f != null) {
            s = s + " lastTimeUsedJournal=\"" + com.ews.exchange.d.a(this.f) + "\"";
        }
        if (this.g != null) {
            s = s + " lastTimeUsedContacts=\"" + com.ews.exchange.d.a(this.g) + "\"";
        }
        if (this.h != null) {
            s = s + " lastTimeUsedTasks=\"" + com.ews.exchange.d.a(this.h) + "\"";
        }
        if (this.i != null) {
            s = s + " lastTimeUsedCalendar=\"" + com.ews.exchange.d.a(this.i) + "\"";
        }
        if (this.j != null) {
            s = s + " lastTimeUsedMail=\"" + com.ews.exchange.d.a(this.j) + "\"";
        }
        if (this.k != null) {
            s = s + " lastTimeUsed=\"" + com.ews.exchange.d.a(this.k) + "\"";
        }
        String s2 = s + " lastSessionUsed=\"" + this.l + "\"";
        if (this.m != null) {
            s2 = s2 + " guid=\"" + com.ews.exchange.d.a(this.m) + "\"";
        }
        if (this.n) {
