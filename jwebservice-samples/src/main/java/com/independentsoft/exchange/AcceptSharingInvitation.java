...
public class AcceptSharingInvitation extends PostReplyItem
{
    ...
    public AcceptSharingInvitation(final ItemId referenceItemId) {
        this.aw = referenceItemId;
    }
    
    AcceptSharingInvitation(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ItemId") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText10 = reader.getElementText()) != null && elementText10.length() > 0) {
                    this.s = com.independentsoft.exchange.d.c(elementText10);
                }
            }
                ...
                if ((elementText11 = reader.getElementText()) != null && elementText11.length() > 0) {
                    this.N = com.independentsoft.exchange.a.C(elementText11);
                }
            }
                ...
                if ((elementText12 = reader.getElementText()) != null && elementText12.length() > 0) {
                    this.O = com.independentsoft.exchange.a.C(elementText12);
                }
            }
                ...
                if ((elementText15 = reader.getElementText()) != null && elementText15.length() > 0) {
                    this.S = com.independentsoft.exchange.a.D(elementText15);
                }
            }
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("AcceptSharingInvitation") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
    ...
    final String a() {
        String s = "<t:AcceptSharingInvitation>";
        if (this.c != null) {
        ...
        return s + "</t:AcceptSharingInvitation>";
    }
