...
public class PropertyId extends ExtendedPropertyPath
{
    ...
    public String toString() {
        return "<t:ExtendedFieldURI DistinguishedPropertySetId=\"" + com.independentsoft.exchange.a.a(this.b) + "\" PropertyId=\"" + this.a + "\" PropertyType=\"" + com.independentsoft.exchange.a.a(this.c) + "\"/>";
    }
