...
public class MeetingResponse extends MeetingMessage
{
    ...
    MeetingResponse(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        this.a(reader);
    }
        ...
        while (xmlStreamReader.hasNext()) {
            if (xmlStreamReader.isStartElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("ItemId") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText25 = xmlStreamReader.getElementText()) != null && elementText25.length() > 0) {
                    this.s = com.independentsoft.exchange.d.c(elementText25);
                }
            }
                ...
                if ((elementText26 = xmlStreamReader.getElementText()) != null && elementText26.length() > 0) {
                    this.N = com.independentsoft.exchange.a.C(elementText26);
                }
            }
                ...
                if ((elementText27 = xmlStreamReader.getElementText()) != null && elementText27.length() > 0) {
                    this.O = com.independentsoft.exchange.a.C(elementText27);
                }
            }
                ...
                if ((elementText30 = xmlStreamReader.getElementText()) != null && elementText30.length() > 0) {
                    this.S = com.independentsoft.exchange.a.D(elementText30);
                }
            }
            ...
            if (xmlStreamReader.isEndElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("MeetingResponse") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            xmlStreamReader.next();
        }
