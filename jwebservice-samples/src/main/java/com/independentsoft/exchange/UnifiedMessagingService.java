...
public class UnifiedMessagingService
{
    ...
    private InputStream a(final String requestBody) throws Exception {
        ...
        if (!this.h) {
            String s = "<soap:Header>" + "<t:RequestServerVersion Version=\"" + com.independentsoft.exchange.a.a(this.g) + "\"/>";
            if (this.e != null) {
                s = s + "<t:MailboxCulture>" + com.independentsoft.exchange.d.a(this.e) + "</t:MailboxCulture>";
            }
            if (this.f != null) {
                s += this.f.a();
            }
    ...
    private String a(String b, String string) throws ServiceException {
        InputStream a = null;
        String result = null;
        string = "<PlayOnPhone xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><entryId>" + com.independentsoft.exchange.d.a(b) + "</entryId><DialString>" + com.independentsoft.exchange.d.a(string) + "</DialString></PlayOnPhone>";
        try {
    ...
    private String a(GreetingType greetingType, String string) throws ServiceException {
        InputStream a = null;
        String result = null;
        string = "<PlayOnPhoneGreeting xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><GreetingType>" + (((greetingType = greetingType) == GreetingType.OUT_OF_OFFICE) ? "OofCustom" : "NormalCustom") + "</GreetingType><DialString>" + com.independentsoft.exchange.d.a(string) + "</DialString></PlayOnPhoneGreeting>";
        try {
            result = b(a = this.a(string));
        }
        catch (ServiceException ex) {
    ...
    public void setPlayOnPhoneDialString(String dialString) throws ServiceException {
        ...
        final String string = "<SetPlayOnPhoneDialString xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><dialString>" + com.independentsoft.exchange.d.a(dialString) + "</dialString></SetPlayOnPhoneDialString>";
        try {
    ...
    public void setTelephoneAccessFolderEmail(String folderId) throws ServiceException {
        UnifiedMessagingService var_1_03 = this;
        final String string = "<SetTelephoneAccessFolderEmail xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><base64FolderID>" + com.independentsoft.exchange.d.a(folderId) + "</base64FolderID></SetTelephoneAccessFolderEmail>";
        try {
            final InputStream a = ((UnifiedMessagingService)var_1_03).a(string);
            if (a != null) {
                try {
    ...
    public void disconnect(String callId) throws ServiceException {
        UnifiedMessagingService var_1_03 = this;
        final String string = "<Disconnect xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><CallId>" + com.independentsoft.exchange.d.a(callId) + "</CallId></Disconnect>";
        try {
            final InputStream a = ((UnifiedMessagingService)var_1_03).a(string);
            if (a != null) {
                try {
    ...
    private CallInfo b(final String s) throws ServiceException {
        ...
        final String string = "<GetCallInfo xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><CallId>" + com.independentsoft.exchange.d.a(s) + "</CallId></GetCallInfo>";
        try {
