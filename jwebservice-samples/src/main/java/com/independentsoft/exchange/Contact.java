...
public class Contact extends Item
{
        ...
        while (xmlStreamReader.hasNext()) {
            if (xmlStreamReader.isStartElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("ItemId") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText9 = xmlStreamReader.getElementText()) != null && elementText9.length() > 0) {
                    this.an = com.independentsoft.exchange.a.x(elementText9);
                }
            }
                ...
                if ((elementText11 = xmlStreamReader.getElementText()) != null && elementText11.length() > 0) {
                    this.bg = com.independentsoft.exchange.d.c(elementText11);
                }
            }
                ...
                this.bt = com.independentsoft.exchange.a.w(xmlStreamReader.getElementText());
            }
                ...
                if ((elementText13 = xmlStreamReader.getElementText()) != null && elementText13.length() > 0) {
                    this.bx = com.independentsoft.exchange.d.c(elementText13);
                }
            }
                ...
                if (xmlStreamReader.isStartElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("ManagerMailbox") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                    ...
                    if ((elementText14 = xmlStreamReader.getElementText()) != null && elementText14.length() > 0) {
                        this.bV = com.independentsoft.exchange.d.e(elementText14);
                    }
                }
                    ...
                    if ((elementText15 = xmlStreamReader.getElementText()) != null && elementText15.length() > 0) {
                        this.bU = com.independentsoft.exchange.d.e(elementText15);
                    }
                }
                    ...
                    if ((elementText16 = xmlStreamReader.getElementText()) != null && elementText16.length() > 0) {
                        this.bW = com.independentsoft.exchange.d.e(elementText16);
                    }
                }
                    ...
                    if ((elementText19 = xmlStreamReader.getElementText()) != null && elementText19.length() > 0) {
                        this.s = com.independentsoft.exchange.d.c(elementText19);
                    }
                }
                    ...
                    if ((elementText20 = xmlStreamReader.getElementText()) != null && elementText20.length() > 0) {
                        this.N = com.independentsoft.exchange.a.C(elementText20);
                    }
                }
                    ...
                    if ((elementText21 = xmlStreamReader.getElementText()) != null && elementText21.length() > 0) {
                        this.O = com.independentsoft.exchange.a.C(elementText21);
                    }
                }
                    ...
                    if ((elementText24 = xmlStreamReader.getElementText()) != null && elementText24.length() > 0) {
                        this.S = com.independentsoft.exchange.a.D(elementText24);
                    }
                }
                    ...
                    if ((extendedProperty = new ExtendedProperty(xmlStreamReader)).getPropertyPath() instanceof PropertyTag) {
                        ...
                        if ((propertyTag = (PropertyTag)extendedProperty.getPropertyPath()).getTag() == MapiPropertyTag.PR_DISPLAY_NAME.getTag() && propertyTag.getType() == MapiPropertyTag.PR_DISPLAY_NAME.getType()) {
                            ...
                            if ((value2 = extendedProperty.getValue()) != null && value2.length() > 0) {
                                this.bL = com.independentsoft.exchange.a.y(extendedProperty.getValue());
                            }
                        }
    ...
    final String a() {
        ...
        if (this.bL != Gender.NONE) {
            s += new ExtendedProperty(ContactPropertyPath.GENDER, com.independentsoft.exchange.a.a(this.bL)).toString();
        }
        if (this.bM != null) {
        ...
        if (this.am != null) {
            s = s + "<t:FileAs>" + com.independentsoft.exchange.d.a(this.am) + "</t:FileAs>";
        }
        if (this.an != FileAsMapping.NONE) {
            s = s + "<t:FileAsMapping>" + com.independentsoft.exchange.a.a(this.an) + "</t:FileAsMapping>";
        }
        if (this.ao != null) {
            s = s + "<t:GivenName>" + com.independentsoft.exchange.d.a(this.ao) + "</t:GivenName>";
        }
        if (this.ap != null) {
            s = s + "<t:Initials>" + com.independentsoft.exchange.d.a(this.ap) + "</t:Initials>";
        }
        if (this.aq != null) {
            s = s + "<t:MiddleName>" + com.independentsoft.exchange.d.a(this.aq) + "</t:MiddleName>";
        }
        if (this.ar != null) {
            s = s + "<t:Nickname>" + com.independentsoft.exchange.d.a(this.ar) + "</t:Nickname>";
        }
        if (this.at != null) {
            s = s + "<t:CompanyName>" + com.independentsoft.exchange.d.a(this.at) + "</t:CompanyName>";
        }
        if (this.ax != null || this.ay != null || this.az != null || this.aA != null || this.aB != null || this.aC != null || this.aD != null || this.aE != null || this.aF != null || this.aG != null || this.aH != null || this.aI != null || this.aJ != null || this.aK != null || this.aL != null) {
            ...
            if (this.ax != null || this.ay != null || this.az != null || this.aA != null || this.aB != null) {
                ...
                if (this.ax != null) {
                    s4 = s4 + "<t:Street>" + com.independentsoft.exchange.d.a(this.ax) + "</t:Street>";
                }
                if (this.ay != null) {
                    s4 = s4 + "<t:City>" + com.independentsoft.exchange.d.a(this.ay) + "</t:City>";
                }
                if (this.az != null) {
                    s4 = s4 + "<t:State>" + com.independentsoft.exchange.d.a(this.az) + "</t:State>";
                }
                if (this.aA != null) {
                    s4 = s4 + "<t:CountryOrRegion>" + com.independentsoft.exchange.d.a(this.aA) + "</t:CountryOrRegion>";
                }
                if (this.aB != null) {
                    s4 = s4 + "<t:PostalCode>" + com.independentsoft.exchange.d.a(this.aB) + "</t:PostalCode>";
                }
                s3 = s4 + "</t:Entry>";
            }
            if (this.aC != null || this.aD != null || this.aE != null || this.aF != null || this.aG != null) {
                ...
                if (this.aC != null) {
                    s5 = s5 + "<t:Street>" + com.independentsoft.exchange.d.a(this.aC) + "</t:Street>";
                }
                if (this.aD != null) {
                    s5 = s5 + "<t:City>" + com.independentsoft.exchange.d.a(this.aD) + "</t:City>";
                }
                if (this.aE != null) {
                    s5 = s5 + "<t:State>" + com.independentsoft.exchange.d.a(this.aE) + "</t:State>";
                }
                if (this.aF != null) {
                    s5 = s5 + "<t:CountryOrRegion>" + com.independentsoft.exchange.d.a(this.aF) + "</t:CountryOrRegion>";
                }
                if (this.aG != null) {
                    s5 = s5 + "<t:PostalCode>" + com.independentsoft.exchange.d.a(this.aG) + "</t:PostalCode>";
                }
                s3 = s5 + "</t:Entry>";
            }
            if (this.aH != null || this.aI != null || this.aJ != null || this.aK != null || this.aL != null) {
                ...
                if (this.aH != null) {
                    s6 = s6 + "<t:Street>" + com.independentsoft.exchange.d.a(this.aH) + "</t:Street>";
                }
                if (this.aI != null) {
                    s6 = s6 + "<t:City>" + com.independentsoft.exchange.d.a(this.aI) + "</t:City>";
                }
                if (this.aJ != null) {
                    s6 = s6 + "<t:State>" + com.independentsoft.exchange.d.a(this.aJ) + "</t:State>";
                }
                if (this.aK != null) {
                    s6 = s6 + "<t:CountryOrRegion>" + com.independentsoft.exchange.d.a(this.aK) + "</t:CountryOrRegion>";
                }
                if (this.aL != null) {
                    s6 = s6 + "<t:PostalCode>" + com.independentsoft.exchange.d.a(this.aL) + "</t:PostalCode>";
                }
                s3 = s6 + "</t:Entry>";
            }
        ...
        if (this.aM != null || this.aN != null || this.aO != null || this.aP != null || this.aQ != null || this.aR != null || this.aS != null || this.aT != null || this.aU != null || this.aV != null || this.aW != null || this.aX != null || this.aY != null || this.aZ != null || this.ba != null || this.bb != null || this.bc != null || this.bd != null || this.be != null) {
            ...
            if (this.aM != null) {
                s7 = s7 + "<t:Entry Key=\"AssistantPhone\">" + com.independentsoft.exchange.d.a(this.aM) + "</t:Entry>";
            }
            if (this.aN != null) {
                s7 = s7 + "<t:Entry Key=\"BusinessFax\">" + com.independentsoft.exchange.d.a(this.aN) + "</t:Entry>";
            }
            if (this.aO != null) {
                s7 = s7 + "<t:Entry Key=\"BusinessPhone\">" + com.independentsoft.exchange.d.a(this.aO) + "</t:Entry>";
            }
            if (this.aP != null) {
                s7 = s7 + "<t:Entry Key=\"BusinessPhone2\">" + com.independentsoft.exchange.d.a(this.aP) + "</t:Entry>";
            }
            if (this.aQ != null) {
                s7 = s7 + "<t:Entry Key=\"Callback\">" + com.independentsoft.exchange.d.a(this.aQ) + "</t:Entry>";
            }
            if (this.aR != null) {
                s7 = s7 + "<t:Entry Key=\"CarPhone\">" + com.independentsoft.exchange.d.a(this.aR) + "</t:Entry>";
            }
            if (this.aS != null) {
                s7 = s7 + "<t:Entry Key=\"CompanyMainPhone\">" + com.independentsoft.exchange.d.a(this.aS) + "</t:Entry>";
            }
            if (this.aT != null) {
                s7 = s7 + "<t:Entry Key=\"HomeFax\">" + com.independentsoft.exchange.d.a(this.aT) + "</t:Entry>";
            }
            if (this.aU != null) {
                s7 = s7 + "<t:Entry Key=\"HomePhone\">" + com.independentsoft.exchange.d.a(this.aU) + "</t:Entry>";
            }
            if (this.aV != null) {
                s7 = s7 + "<t:Entry Key=\"HomePhone2\">" + com.independentsoft.exchange.d.a(this.aV) + "</t:Entry>";
            }
            if (this.aW != null) {
                s7 = s7 + "<t:Entry Key=\"Isdn\">" + com.independentsoft.exchange.d.a(this.aW) + "</t:Entry>";
            }
            if (this.aX != null) {
                s7 = s7 + "<t:Entry Key=\"MobilePhone\">" + com.independentsoft.exchange.d.a(this.aX) + "</t:Entry>";
            }
            if (this.aY != null) {
                s7 = s7 + "<t:Entry Key=\"OtherFax\">" + com.independentsoft.exchange.d.a(this.aY) + "</t:Entry>";
            }
            if (this.aZ != null) {
                s7 = s7 + "<t:Entry Key=\"OtherTelephone\">" + com.independentsoft.exchange.d.a(this.aZ) + "</t:Entry>";
            }
            if (this.ba != null) {
                s7 = s7 + "<t:Entry Key=\"Pager\">" + com.independentsoft.exchange.d.a(this.ba) + "</t:Entry>";
            }
            if (this.bb != null) {
                s7 = s7 + "<t:Entry Key=\"PrimaryPhone\">" + com.independentsoft.exchange.d.a(this.bb) + "</t:Entry>";
            }
            if (this.bc != null) {
                s7 = s7 + "<t:Entry Key=\"RadioPhone\">" + com.independentsoft.exchange.d.a(this.bc) + "</t:Entry>";
            }
            if (this.bd != null) {
                s7 = s7 + "<t:Entry Key=\"Telex\">" + com.independentsoft.exchange.d.a(this.bd) + "</t:Entry>";
            }
            if (this.be != null) {
                s7 = s7 + "<t:Entry Key=\"TtyTddPhone\">" + com.independentsoft.exchange.d.a(this.be) + "</t:Entry>";
            }
            s = s7 + "</t:PhoneNumbers>";
        }
        if (this.bf != null) {
            s = s + "<t:AssistantName>" + com.independentsoft.exchange.d.a(this.bf) + "</t:AssistantName>";
        }
        if (this.bg != null) {
            s = s + "<t:Birthday>" + com.independentsoft.exchange.d.a(this.bg) + "</t:Birthday>";
        }
        if (this.bh != null) {
            s = s + "<t:BusinessHomePage>" + com.independentsoft.exchange.d.a(this.bh) + "</t:BusinessHomePage>";
        }
        if (this.bi.size() > 0) {
            String s8 = s + "<t:Children>";
            for (int k = 0; k < this.bi.size(); ++k) {
                if (this.bi.get(k) != null) {
                    s8 = s8 + "<t:String>" + com.independentsoft.exchange.d.a(this.bi.get(k)) + "</t:String>";
                }
            }
            s = s8 + "</t:Children>";
        }
        if (this.bj.size() > 0) {
            ...
            for (int l = 0; l < this.bj.size(); ++l) {
                if (this.bj.get(l) != null) {
                    s9 = s9 + "<t:String>" + com.independentsoft.exchange.d.a(this.bj.get(l)) + "</t:String>";
                }
            }
            s = s9 + "</t:Companies>";
        }
        if (this.bk != null) {
            s = s + "<t:Department>" + com.independentsoft.exchange.d.a(this.bk) + "</t:Department>";
        }
        if (this.bl != null) {
            s = s + "<t:Generation>" + com.independentsoft.exchange.d.a(this.bl) + "</t:Generation>";
        }
        if (this.bm != null || this.bn != null || this.bo != null) {
            String s10 = s + "<t:ImAddresses>";
            if (this.bm != null) {
                s10 = s10 + "<t:Entry Key=\"ImAddress1\">" + com.independentsoft.exchange.d.a(this.bm) + "</t:Entry>";
            }
            if (this.bn != null) {
                s10 = s10 + "<t:Entry Key=\"ImAddress2\">" + com.independentsoft.exchange.d.a(this.bn) + "</t:Entry>";
            }
            if (this.bo != null) {
                s10 = s10 + "<t:Entry Key=\"ImAddress3\">" + com.independentsoft.exchange.d.a(this.bo) + "</t:Entry>";
            }
            s = s10 + "</t:ImAddresses>";
        }
        if (this.bp != null) {
            s = s + "<t:JobTitle>" + com.independentsoft.exchange.d.a(this.bp) + "</t:JobTitle>";
        }
        if (this.bq != null) {
            s = s + "<t:Manager>" + com.independentsoft.exchange.d.a(this.bq) + "</t:Manager>";
        }
        if (this.br != null) {
            s = s + "<t:Mileage>" + com.independentsoft.exchange.d.a(this.br) + "</t:Mileage>";
        }
        if (this.bs != null) {
            s = s + "<t:OfficeLocation>" + com.independentsoft.exchange.d.a(this.bs) + "</t:OfficeLocation>";
        }
        ...
        if (this.bu != null) {
            s = s + "<t:Profession>" + com.independentsoft.exchange.d.a(this.bu) + "</t:Profession>";
        }
        if (this.bv != null) {
            s = s + "<t:SpouseName>" + com.independentsoft.exchange.d.a(this.bv) + "</t:SpouseName>";
        }
        if (this.bw != null) {
            s = s + "<t:Surname>" + com.independentsoft.exchange.d.a(this.bw) + "</t:Surname>";
        }
        if (this.bx != null) {
            s = s + "<t:WeddingAnniversary>" + com.independentsoft.exchange.d.a(this.bx) + "</t:WeddingAnniversary>";
        }
        return s + "</t:Contact>";
    }
