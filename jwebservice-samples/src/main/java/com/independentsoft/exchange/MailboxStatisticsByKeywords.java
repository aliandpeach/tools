    ...
    final String a() {
        ...
        for (int j = 0; j < this.b.size(); ++j) {
            if (this.b.get(j) != null) {
                s2 = s2 + "<t:String>" + com.independentsoft.exchange.d.a(this.b.get(j)) + "</t:String>";
            }
        }
        String s3 = s2 + "</Keywords>";
        if (this.c != null) {
            s3 = s3 + "<Language>" + com.independentsoft.exchange.d.a(this.c) + "</Language>";
        }
        if (this.d != null && this.e.size() > 0) {
            String s4 = s3 + "<Senders>";
            for (int k = 0; k < this.d.size(); ++k) {
                if (this.d.get(k) != null) {
                    s4 = s4 + "<t:SmtpAddress>" + com.independentsoft.exchange.d.a(this.d.get(k)) + "</t:SmtpAddress>";
                }
            }
            s3 = s4 + "</Senders>";
        }
        if (this.e != null && this.e.size() > 0) {
            ...
            for (int l = 0; l < this.e.size(); ++l) {
                if (this.e.get(l) != null) {
                    s5 = s5 + "<t:SmtpAddress>" + com.independentsoft.exchange.d.a(this.e.get(l)) + "</t:SmtpAddress>";
                }
            }
            s3 = s5 + "</Recipients>";
        }
        if (this.f != null) {
            s3 = s3 + "<FromDate>" + com.independentsoft.exchange.d.a(this.f) + "</FromDate>";
        }
        if (this.g != null) {
            s3 = s3 + "<ToDate>" + com.independentsoft.exchange.d.a(this.g) + "</ToDate>";
        }
