...
public class Property
{
    ...
    public Property(PropertyPath propertyPath, final Object value) {
        ...
        if (value instanceof FlagIcon) {
            this.b = com.independentsoft.exchange.a.a((FlagIcon)value);
            return;
        }
        if (value instanceof FlagStatus) {
            this.b = com.independentsoft.exchange.a.a((FlagStatus)value);
            return;
        }
        if (value instanceof LegacyFreeBusy) {
            this.b = com.independentsoft.exchange.a.a((LegacyFreeBusy)value);
            return;
        }
        if (value instanceof MeetingStatus) {
            this.b = com.independentsoft.exchange.a.a((MeetingStatus)value);
            return;
        }
        if (value instanceof NoteColor) {
            this.b = com.independentsoft.exchange.a.a((NoteColor)value);
            return;
        }
        if (value instanceof ResponseStatus) {
            this.b = com.independentsoft.exchange.a.a((ResponseStatus)value);
            return;
        }
        if (value instanceof Gender) {
            this.b = com.independentsoft.exchange.a.a((Gender)value);
            return;
        }
        if (value instanceof Sensitivity) {
            this.b = com.independentsoft.exchange.a.a((Sensitivity)value);
            return;
        }
        if (value instanceof TaskStatus) {
            this.b = com.independentsoft.exchange.a.a((TaskStatus)value);
            return;
        }
        if (value instanceof BusyStatus) {
            this.b = com.independentsoft.exchange.a.a((BusyStatus)value);
            return;
        }
        if (value instanceof FileAsMapping) {
            this.b = com.independentsoft.exchange.a.a((FileAsMapping)value);
            return;
        }
        if (value instanceof Importance) {
            this.b = com.independentsoft.exchange.a.a((Importance)value);
            return;
        }
        if (value != null) {
...
//                propertyPath = (PropertyPath)value;
    ...
    String a() {
        ...
        if (this.b != null && this.a instanceof UnindexedPropertyPath) {
            ...
            final String f = com.independentsoft.exchange.d.f(unindexedPropertyPath.getUri());
            final String g = com.independentsoft.exchange.d.g(unindexedPropertyPath.getUri());
            ...
            if (this.d && (this.a == ItemPropertyPath.BODY || this.a == AppointmentPropertyPath.MEETING_TIME_ZONE || this.a == AppointmentPropertyPath.RECURRENCE || this.a == AppointmentPropertyPath.START_TIME_ZONE || this.a == AppointmentPropertyPath.END_TIME_ZONE || this.a == ItemPropertyPath.FLAG)) {
                ...
                s2 = string2 + "<t:" + g + ">" + com.independentsoft.exchange.d.a(this.b) + "</t:" + g + ">";
            }
            s = s2 + "</t:" + f + ">";
        }
            ...
            final String f2 = com.independentsoft.exchange.d.f(unindexedPropertyPath2.getUri());
            final String g2 = com.independentsoft.exchange.d.g(unindexedPropertyPath2.getUri());
            String s3 = string3 + "<t:" + f2 + ">" + "<t:" + g2 + ">";
            for (int i = 0; i < this.c.size(); ++i) {
                s3 = s3 + "<t:String>" + com.independentsoft.exchange.d.a(this.c.get(i)) + "</t:String>";
            }
            s = s3 + "</t:" + g2 + ">" + "</t:" + f2 + ">";
        }
            ...
            s = s + indexedPropertyPath.toString() + com.independentsoft.exchange.d.a(indexedPropertyPath.getUri(), indexedPropertyPath.getIndex(), this.b);
        }
            ...
            if (this.d && this.b != null && this.b.length() > 0 && this.a == MapiPropertyTag.PR_RTF_COMPRESSED) {
                try {
                    final byte[] e = com.independentsoft.exchange.d.e(this.b);
                    ...
                    this.b = com.independentsoft.exchange.d.a(byteArrayOutputStream.toByteArray());
                }
    ...
    String b() {
        ...
        if (this.b != null && this.a instanceof UnindexedPropertyPath) {
            ...
            if (this.b.indexOf("CalendarPermissions") == -1 && this.d && unindexedPropertyPath == FolderPropertyPath.PERMISSION_SET) {
                ...
                s = string + "<t:Folder>" + "<t:" + g + ">" + com.independentsoft.exchange.d.a(this.b) + "</t:" + g + ">" + "</t:Folder>";
            }
