...
public class SuppressReadReceipt extends ResponseItem
{
    ...
    public SuppressReadReceipt(final ItemId referenceItemId) {
        this.aw = referenceItemId;
    }
    
    SuppressReadReceipt(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("SuppressReadReceipt") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
    ...
    final String a() {
        String s = "<t:SuppressReadReceipt>";
        if (this.c != null) {
        ...
        return s + "</t:SuppressReadReceipt>";
    }
