...
public class ContentSettings
{
    ...
    ContentSettings(final XMLStreamReader reader) {
        ...
        if (attributeValue2 != null && attributeValue2.length() > 0) {
            this.d = com.independentsoft.exchange.a.m(attributeValue2);
        }
    }
    ...
    final String a() {
        ...
        if (this.a != null) {
            s = s + " Guid=\"" + com.independentsoft.exchange.d.a(this.a) + "\"";
        }
        if (this.b > 0) {
            s = s + " ExpiryAgeLimit=\"" + this.b + "\"";
        }
        if (this.c != null) {
            s = s + " MessageClass=\"" + com.independentsoft.exchange.d.a(this.c) + "\"";
        }
