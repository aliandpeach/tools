...
public class UserId
{
    ...
    final String a() {
        String s = "<t:UserId>";
        if (this.a != null) {
            s = s + "<t:SID>" + com.independentsoft.exchange.d.a(this.a) + "</t:SID>";
        }
        if (this.b != null) {
            s = s + "<t:PrimarySmtpAddress>" + com.independentsoft.exchange.d.a(this.b) + "</t:PrimarySmtpAddress>";
        }
        if (this.c != null) {
            s = s + "<t:DisplayName>" + com.independentsoft.exchange.d.a(this.c) + "</t:DisplayName>";
        }
