...
public class DomainSetting
{
    ...
    DomainSetting(final XMLStreamReader reader) throws XMLStreamException {
        this.d = new ArrayList<WebClientUrl>();
        this.e = new ArrayList<ProtocolConnection>();
        this.a(reader);
    }
    ...
    private void a(final XMLStreamReader xmlStreamReader) throws XMLStreamException {
        ...
        while (xmlStreamReader.hasNext()) {
            ...
            if (xmlStreamReader.isEndElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("DomainSetting") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/2010/Autodiscover")) {
                break;
            }
            xmlStreamReader.next();
        }
