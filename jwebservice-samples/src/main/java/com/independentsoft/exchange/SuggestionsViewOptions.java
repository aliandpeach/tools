...
public class SuggestionsViewOptions
{
    ...
    final String a() {
        ...
        if (this.g != null) {
            s = s + "<t:CurrentMeetingTime>" + com.independentsoft.exchange.d.a(this.g) + "</t:CurrentMeetingTime>";
        }
        if (this.h != null) {
            s = s + "<t:GlobalObjectId>" + com.independentsoft.exchange.d.a(this.h) + "</t:GlobalObjectId>";
        }
