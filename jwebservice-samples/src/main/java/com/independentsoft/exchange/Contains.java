...
public class Contains extends Restriction
{
    ...
    public Contains(final PropertyPath propertyPath, final Date value, final ContainmentMode mode, final ContainmentComparison comparison) {
        this(propertyPath, com.independentsoft.exchange.d.a(value), mode, comparison);
    }
    ...
    public String toString() {
        ...
        if (this.a != null && this.b != null) {
            string = string + "<t:Contains" + s + ">" + this.a.toString() + "<t:Constant Value=\"" + com.independentsoft.exchange.d.a(this.b) + "\"/>" + "</t:Contains>";
        }
        return string;
    }
