...
public class TentativelyAcceptItem extends MeetingRegistrationResponse
{
    ...
    public TentativelyAcceptItem(final ItemId referenceItemId) {
        this.aw = referenceItemId;
    }
    
    TentativelyAcceptItem(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("TentativelyAcceptItem") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
    ...
    final String a() {
        String s = "<t:TentativelyAcceptItem>";
        if (this.c != null) {
        ...
        return s + "</t:TentativelyAcceptItem>";
    }
}
