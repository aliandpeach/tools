...
public class Journal extends Item
{
    ...
    final String a() {
        ...
        if (this.V != null) {
            s += new ExtendedProperty(JournalPropertyPath.TYPE, com.independentsoft.exchange.d.a(this.V)).toString();
        }
        if (this.W != null) {
            s += new ExtendedProperty(JournalPropertyPath.TYPE_DESCRIPTION, com.independentsoft.exchange.d.a(this.W)).toString();
        }
        if (this.X > 0) {
