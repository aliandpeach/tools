...
{
    private String am;
    private ContactSource an;
    private List<DistributionListMember> ao;
    
    public DistributionList() {
        this.an = ContactSource.NONE;
        this.ao = new ArrayList<DistributionListMember>();
    }
    
    DistributionList(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        this.an = ContactSource.NONE;
        this.ao = new ArrayList<DistributionListMember>();
        this.a(reader);
    }
    ...
    private void a(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ItemId") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
            ...
            else if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("FileAs") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                this.am = reader.getElementText();
            }
            else if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ContactSource") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                final String elementText9;
                if ((elementText9 = reader.getElementText()) != null && elementText9.length() > 0) {
                    final String s;
                    this.an = ((s = elementText9).equals("ActiveDirectory") ? ContactSource.ACTIVE_DIRECTORY : (s.equals("Store") ? ContactSource.STORE : ContactSource.NONE));
                }
            }
            else if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("Members") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                while (reader.hasNext()) {
                    if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("Member") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                        this.ao.add(new DistributionListMember(reader));
                    }
                    if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("Members") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                        break;
                    }
                    reader.next();
                }
                ...
                if ((elementText10 = reader.getElementText()) != null && elementText10.length() > 0) {
                    this.w = Boolean.parseBoolean(elementText10);
                }
            }
                ...
                if ((elementText11 = reader.getElementText()) != null && elementText11.length() > 0) {
                    this.s = com.independentsoft.exchange.d.c(elementText11);
                }
            }
                ...
                if ((elementText12 = reader.getElementText()) != null && elementText12.length() > 0) {
                    this.N = com.independentsoft.exchange.a.C(elementText12);
                }
            }
                ...
                if ((elementText13 = reader.getElementText()) != null && elementText13.length() > 0) {
                    this.O = com.independentsoft.exchange.a.C(elementText13);
                }
            }
                ...
                if ((elementText14 = reader.getElementText()) != null && elementText14.length() > 0) {
                    this.P = Boolean.parseBoolean(elementText14);
                }
            }
                ...
                if ((elementText15 = reader.getElementText()) != null && elementText15.length() > 0) {
                    this.Q = Boolean.parseBoolean(elementText15);
                }
            }
                ...
                if ((elementText16 = reader.getElementText()) != null && elementText16.length() > 0) {
                    this.S = com.independentsoft.exchange.a.D(elementText16);
                }
            }
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("DistributionList") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
    ...
    final String a() {
        ...
        if (this.ao != null && this.ao.size() > 0) {
            String s3 = s + "<t:Members>";
            for (int k = 0; k < this.ao.size(); ++k) {
                if (this.ao.get(k) != null) {
                    s3 += this.ao.get(k).a();
                }
            }
            s = s3 + "</t:Members>";
