...
public class ItemShape
{
    ...
    public String toString() {
        String s = "<ItemShape>" + "<t:BaseShape>" + com.independentsoft.exchange.a.a(this.a) + "</t:BaseShape>";
        if (this.c) {
            s += "<t:IncludeMimeContent>true</t:IncludeMimeContent>";
        }
        if (this.d != BodyType.NONE) {
            s = s + "<t:BodyType>" + com.independentsoft.exchange.a.a(this.d) + "</t:BodyType>";
        }
        if (this.e) {
        ...
        if (this.g != null) {
            s = s + "<t:InlineImageUrlTemplate>" + com.independentsoft.exchange.d.a(this.g) + "</t:InlineImageUrlTemplate>";
        }
        if (this.h) {
