...
public class Mailbox
{
    ...
    final String a(final String s) {
        String s2 = "<" + s + ">";
        if (this.a != null) {
            s2 = s2 + "<t:Name>" + com.independentsoft.exchange.d.a(this.a) + "</t:Name>";
        }
        if (this.b != null) {
            s2 = s2 + "<t:EmailAddress>" + com.independentsoft.exchange.d.a(this.b) + "</t:EmailAddress>";
        }
        if (this.c != null) {
            s2 = s2 + "<t:RoutingType>" + com.independentsoft.exchange.d.a(this.c) + "</t:RoutingType>";
        }
        ...
        if (this.f != null) {
            s2 = s2 + "<t:OriginalDisplayName>" + com.independentsoft.exchange.d.a(this.f) + "</t:OriginalDisplayName>";
        }
        return s2 + "</" + s + ">";
    }
