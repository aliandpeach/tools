...
public class UploadItemsResponse extends Response
{
    ...
    UploadItemsResponse(final XMLStreamReader reader) throws XMLStreamException {
        ...
        while (reader.hasNext()) {
            if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("MessageText") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/messages")) {
                ...
                this.g = new ItemId();
                this.g.id = reader.getAttributeValue("", "Id");
                this.g.changeKey = reader.getAttributeValue("", "ChangeKey");
            }
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("UploadItemsResponseMessage") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/messages")) {
                break;
            }
            reader.next();
        }
