...
public class Service
{
    ...
    private InputStream a(final String s, final boolean b) throws Exception {
        ...
        if (!this.m) {
            String s2 = "<soap:Header>" + "<t:RequestServerVersion Version=\"" + com.independentsoft.exchange.a.a(this.g) + "\"/>";
            if (this.e != null) {
                s2 = s2 + "<t:MailboxCulture>" + com.independentsoft.exchange.d.a(this.e) + "</t:MailboxCulture>";
            }
            if (this.f != null) {
                s2 += this.f.a();
            }
...
//                    this.q = custom3.build();
        ...
        try {
            ...
            o = "<soap:Header>";
            o = (String)o + "<t:RequestServerVersion Version=\"" + com.independentsoft.exchange.a.a(this.g) + "\"/>";
            if (this.e != null) {
                o = (String)o + "<t:MailboxCulture>" + com.independentsoft.exchange.d.a(this.e) + "</t:MailboxCulture>";
            }
            if (this.f != null) {
                o = (String)o + this.f.a();
            }
            ...
            httpURLConnection.setRequestProperty("User-Agent", com.independentsoft.exchange.b.a);
            if (this.l != null && this.l.getAccessToken() != null) {
    ...
    private InputStream a(final String s, final String s2) throws Exception {
        if (!this.m) {
            ...
            while (i != 0) {
                final HttpPost httpPost;
                (httpPost = new HttpPost(new URI(s))).setHeader("User-Agent", com.independentsoft.exchange.b.a);
                httpPost.setEntity((HttpEntity)entity);
                if (this.j) {
                    httpPost.setHeader("Accept-Encoding", "gzip");
                }
    ...
    public String getSignInRequestUri(final String redirectUri, String responseType, String responseMode, String state, String nonce, String loginHint, String domainHint, String prompt) {
        ...
        String s = k(this.y) + "/authorize?" + "client_id=" + this.x + "&scope=" + com.independentsoft.exchange.d.a(this.z);
    ...
    private OAuthToken a(final String s, final String s2, final String s3) throws ServiceException {
        ...
        String s4 = "" + "client_id=" + this.x + "&scope=" + com.independentsoft.exchange.d.a(this.z) + "&code=" + s + "&redirect_uri=" + s2 + "&grant_type=authorization_code";
        while (true) {
            if (s3 != null) {
    ...
    public String getAuthorizationCodeRequestUri(final String redirectUri, String responseMode, String state) {
        ...
        final String string = k(this.y) + "/authorize?" + "client_id=" + this.x + "&scope=" + com.independentsoft.exchange.d.a(this.z) + "&response_type=code" + "&redirect_uri=" + responseMode;
        String s;
        if (state != null) {
    ...
    private OAuthToken a(final String s) throws ServiceException {
        ...
        final String string = k(this.y) + "/token";
        final String string2 = "" + "client_id=" + this.x + "&scope=" + com.independentsoft.exchange.d.a(this.z) + "&client_assertion=" + s + "&grant_type=client_credentials" + "&client_assertion_type=urn:ietf:params:oauth:client-assertion-type:jwt-bearer";
        try {
            final JsonObject jsonObject;
    ...
    private OAuthToken b(final String s) throws ServiceException {
        ...
        final String string = k(this.y) + "/token";
        final String string2 = "" + "client_id=" + this.x + "&scope=" + com.independentsoft.exchange.d.a(this.z) + "&client_secret=" + s + "&grant_type=client_credentials";
        try {
            final JsonObject jsonObject;
            if ((jsonObject = (JsonObject)new JsonParser(new InputStreamReader(this.a(string, string2), StandardCharsets.UTF_8)).parse()) != null) {
                this.l = new OAuthToken(jsonObject);
    ...
    private OAuthToken a(final String s, final String s2, final String s3, final String s4) throws ServiceException {
        ...
        final String string = k(this.y) + "/token";
        String s5 = "" + "client_id=" + this.x + "&scope=" + com.independentsoft.exchange.d.a(this.z) + "&username=" + s + "&password=" + s2 + "&grant_type=password";
        if (s3 != null) {
    ...
    private DeviceAuthorizationCode b() throws ServiceException {
        ...
        final String string2 = "" + "client_id=" + this.x + "&scope=" + com.independentsoft.exchange.d.a(this.z);
    ...
    private OAuthToken a(final String s, String string, final String s2, final List<String> list, final String s3) throws ServiceException {
        ...
        String s4 = "" + "client_id=" + s + "&scope=" + com.independentsoft.exchange.d.a(list) + "&refresh_token=" + s2 + "&grant_type=refresh_token ";
        while (true) {
            if (s3 != null) {
                s4 = s4 + "&client_secret=" + s3;
                try {
    ...
    private List<ItemInfoResponse> a(List<ItemId> o, ItemShape itemShape) throws ServiceException {
        ...
        if ((itemInfoResponseList).size() == 1 && ((itemInfoResponseList).get(0)).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(((itemInfoResponseList).get(0)).getResponseCode()), ((itemInfoResponseList).get(0)).getMessage(), ((itemInfoResponseList).get(0)).getXmlMessage(), requestBody, ((itemInfoResponseList).get(0)).getServerVersionInfo());
        }
    ...
    private List<ItemInfoResponse> a(List<ItemId> var1, final boolean var2, final FolderId var3) throws ServiceException {
        ...
        if (itemInfoResponseList.size() == 1 && (itemInfoResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            var5 = com.independentsoft.exchange.a.a((itemInfoResponseList.get(0)).getResponseCode());
    ...
    public List<ItemInfoResponse> createItemImplementation(List<Item> items, FolderId parentFolderId, MessageDisposition messageDisposition, SendMeetingInvitations sendMeetingInvitations) throws ServiceException {
        ...
        try {
            messageDisposition1 = " MessageDisposition=\"" + com.independentsoft.exchange.a.a(messageDisposition) + "\"";
            messageDisposition1 = messageDisposition1 + " SendMeetingInvitations=\"" + com.independentsoft.exchange.a.a(sendMeetingInvitations) + "\"";
        ...
        if (itemInfoResponseList.size() == 1 && (itemInfoResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            messageDisposition1 = com.independentsoft.exchange.a.a((itemInfoResponseList.get(0)).getResponseCode());
    ...
    private ResolveNamesResponse a(String var1, FolderId var2, boolean var3, ResolveNamesSearchScope var4, ContactDataShapeType var5) throws ServiceException {
        ...
        try {
            ...
            var6 = var6 + "<UnresolvedEntry>" + com.independentsoft.exchange.d.a(var1) + "</UnresolvedEntry>";
        ...
        if (var17.getResponseClass() == ResponseClass.ERROR) {
            var20 = com.independentsoft.exchange.a.a(var17.getResponseCode());
        ...
        if (var1 == null) {
            ...
            try {
                ...
                if (var3 != MailboxSearchLocation.NONE) {
                    var7 = var7 + "<MailboxScope>" + com.independentsoft.exchange.a.a(var3) + "</MailboxScope>";
                }
            ...
            if (conversationItemResponseList.size() == 1 && (conversationItemResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
                var18 = com.independentsoft.exchange.a.a((conversationItemResponseList.get(0)).getResponseCode());
    ...
    private List<Response> a(List<FolderId> var1, boolean var2, boolean var3) throws ServiceException {
        ...
        if (responseList.size() == 1 && (responseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            var5 = com.independentsoft.exchange.a.a((responseList.get(0)).getResponseCode());
    ...
    private List<FolderInfoResponse> a(List<FolderId> var1, FolderShape var2) throws ServiceException {
        ...
        if (var1 == null) {
            ...
            if (folderInfoResponseList.size() == 1 && (folderInfoResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
                var16 = com.independentsoft.exchange.a.a((folderInfoResponseList.get(0)).getResponseCode());
    ...
    private List<FolderInfoResponse> a(List<FolderChange> var1) throws ServiceException {
        ...
        if (folderInfoResponseList.size() == 1 && (folderInfoResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            String var16 = com.independentsoft.exchange.a.a((folderInfoResponseList.get(0)).getResponseCode());
            String var4 = (folderInfoResponseList.get(0)).getMessage();
            String var5 = (folderInfoResponseList.get(0)).getXmlMessage();
            ServerVersionInfo var15 = (folderInfoResponseList.get(0)).getServerVersionInfo();
    ...
    private List<FolderInfoResponse> a(List<String> var1, Mailbox var2) throws ServiceException {
        ...
        try {
            ...
            for(int var5 = 0; var5 < var1.size(); ++var5) {
                var4 = var4 + "<t:FolderName>" + com.independentsoft.exchange.d.a((String)var1.get(var5)) + "</t:FolderName>";
            }
        ...
        if (folderInfoResponseList.size() == 1 && (folderInfoResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            var4 = com.independentsoft.exchange.a.a((folderInfoResponseList.get(0)).getResponseCode());
    ...
    private List<FolderInfoResponse> a(List<Folder> o, final FolderId folderId) throws ServiceException {
        ...
        if (folderInfoResponseList.size() == 1 && (folderInfoResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((folderInfoResponseList.get(0)).getResponseCode()), (folderInfoResponseList.get(0)).getMessage(), (folderInfoResponseList.get(0)).getXmlMessage(), requestBody, (folderInfoResponseList.get(0)).getServerVersionInfo());
        }
        return folderInfoResponseList;
    }
    ...
    private List<Response> a(List<FolderId> o, final DeleteType deleteType) throws ServiceException {
        ...
        try {
            final String string = " DeleteType=\"" + com.independentsoft.exchange.a.a(deleteType) + "\"";
            final String i = i((List<FolderId>)o);
        ...
        if (responseList.size() == 1 && responseList.get(0).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(responseList.get(0).getResponseCode()), responseList.get(0).getMessage(), responseList.get(0).getXmlMessage(), requestBody, responseList.get(0).getServerVersionInfo());
        }
        return responseList;
    }
    ...
    private List<Response> a(List<ItemId> o, final DeleteType deleteType, final SendMeetingInvitations sendMeetingInvitations, final AffectedTaskOccurrences affectedTaskOccurrences) throws ServiceException {
        String requestBody = null;List<Response> responseList = new ArrayList<>();
        try {
            requestBody = "<DeleteItem xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\" xmlns:t=\"http://schemas.microsoft.com/exchange/services/2006/types\"" + (" DeleteType=\"" + com.independentsoft.exchange.a.a(deleteType) + "\"" + " SendMeetingCancellations=\"" + com.independentsoft.exchange.a.a(sendMeetingInvitations) + "\"" + " AffectedTaskOccurrences=\"" + ((affectedTaskOccurrences == AffectedTaskOccurrences.SPECIFIED_OCCURRENCE_ONLY) ? "SpecifiedOccurrenceOnly" : "AllOccurrences") + "\"") + ">";
            requestBody += "<ItemIds>";
            for (int i = 0; i < ((List)o).size(); ++i) {
                requestBody += ((List<ItemId>)o).get(i).a();
            }
    ...
    private List<ItemInfoResponse> a(List<ItemChange> o, ConflictResolution conflictResolution, final MessageDisposition messageDisposition, final SendMeetingOption sendMeetingOption, final FolderId folderId) throws ServiceException {
        ...
        if (infoResponseList.size() == 1 && (infoResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((infoResponseList.get(0)).getResponseCode()), (infoResponseList.get(0)).getMessage(), (infoResponseList.get(0)).getXmlMessage(), requestBody, (infoResponseList.get(0)).getServerVersionInfo());
        }
    ...
    private List<CreateAttachmentResponse> a(List<Attachment> o, final ItemId itemId) throws ServiceException {
        ...
        if (createAttachmentResponseList.size() == 1 && (createAttachmentResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((createAttachmentResponseList.get(0)).getResponseCode()), (createAttachmentResponseList.get(0)).getMessage(), (createAttachmentResponseList.get(0)).getXmlMessage(), requestBody, (createAttachmentResponseList.get(0)).getServerVersionInfo());
        }
    ...
    private ItemId b(List<String> a) throws ServiceException {
        ...
        try {
            ...
            for (int i = 0; i < ((List)a).size(); ++i) {
                requestBody = requestBody + "<t:AttachmentId Id=\"" + com.independentsoft.exchange.d.a(((List<String>)a).get(i)) + "\"/>";
            }
            requestBody += "</AttachmentIds>";
            final String string;
        ...
        if (deleteAttachmentResponse.getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((deleteAttachmentResponse).getResponseCode()), (deleteAttachmentResponse).getMessage(), (deleteAttachmentResponse).getXmlMessage(), requestBody, (deleteAttachmentResponse).getServerVersionInfo());
        }
    ...
    private List<Attachment> a(List<String> a, final AttachmentShape attachmentShape) throws ServiceException {
        ...
        if (response.getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(response.getResponseCode()), response.getMessage(), response.getXmlMessage(), requestBody, response.getServerVersionInfo());
        }
    ...
    private List<FindFolderResponse> a(List<FolderId> var1, FolderShape var2, Restriction var3, PageView var4, FolderQueryTraversal var5) throws ServiceException {
        ...
        if (var1 == null) {
            ...
            if (findFolderResponseList.size() == 1 && (findFolderResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
                var7 = com.independentsoft.exchange.a.a((findFolderResponseList.get(0)).getResponseCode());
    ...
    private List<FindItemResponse> a(List<FolderId> var1, ItemShape var2, Restriction var3, IGroupBy var4, List<PropertyOrder> var5, View var6, ItemQueryTraversal var7, QueryString var8) throws ServiceException {
        ...
        if (var1 == null) {
            ...
            if (findItemResponseList.size() == 1 && (findItemResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
                var10 = com.independentsoft.exchange.a.a((findItemResponseList.get(0)).getResponseCode());
    ...
    private Persona a(ItemId itemId) throws ServiceException {
        ...
        if (response.getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(response.getResponseCode()), response.getMessage(), response.getXmlMessage(), string, response.getServerVersionInfo());
        }
    ...
    private FindPeopleResponse a(FolderId folderId, final PersonaShape personaShape, final Restriction restriction, final Restriction restriction2, final List<PropertyOrder> list, IndexedPageView indexedPageView, final String s) throws ServiceException {
        ...
        Label_0038: {
            ...
            try {
                ...
                if (s != null) {
                    requestBody = requestBody + "<QueryString>" + com.independentsoft.exchange.d.a(s) + "</QueryString>";
                }
                final String string;
        ...
        if (var1 == null) {
            ...
            try {
                ...
                if (var3 != DeliverMeetingRequests.NONE) {
                    var4 = var4 + "<DeliverMeetingRequests>" + com.independentsoft.exchange.a.a(var3) + "</DeliverMeetingRequests>";
                }
            ...
            if (var16.getResponseClass() == ResponseClass.ERROR) {
                var20 = com.independentsoft.exchange.a.a(var16.getResponseCode());
                ...
                var20 = com.independentsoft.exchange.a.a(((DelegateUserResponse)var16.getDelegateUserResponses().get(0)).getResponseCode());
    ...
    private DelegateResponse a(Mailbox a, final List<UserId> list) throws ServiceException {
        ...
        if (response.getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((response).getResponseCode()), (response).getMessage(), (response).getXmlMessage(), s, (response).getServerVersionInfo());
        }
        if ((response).getDelegateUserResponses().size() == 1 && (response).getDelegateUserResponses().get(0).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((response).getDelegateUserResponses().get(0).getResponseCode()), (response).getDelegateUserResponses().get(0).getMessage(), (response).getDelegateUserResponses().get(0).getXmlMessage(), s, (response).getServerVersionInfo());
        }
        return response;
    }
    ...
    private GetEventsResponse b(String a, String responseCode) throws ServiceException {
        ...
        try {
            ...
            requestBody = requestBody + "<SubscriptionId>" + com.independentsoft.exchange.d.a(a) + "</SubscriptionId>";
            requestBody = requestBody + "<Watermark>" + com.independentsoft.exchange.d.a(responseCode) + "</Watermark>";
        ...
        if (response.getResponseClass() == ResponseClass.ERROR) {
            responseCode = com.independentsoft.exchange.a.a((response).getResponseCode());
    ...
    private InputStream a(final List<String> list, int n) throws ServiceException {
        ...
        try {
            ...
            for (int i = 0; i < list.size(); ++i) {
                requestBody = requestBody + "<t:SubscriptionId>" + com.independentsoft.exchange.d.a(list.get(i)) + "</t:SubscriptionId>";
            }
            requestBody += "</SubscriptionIds>";
    ...
    private Response d(String a) throws ServiceException {
        ...
        try {
            ...
            string = string + "<SubscriptionId>" + com.independentsoft.exchange.d.a(a) + "</SubscriptionId>";
            final String string2;
    ...
    public String sendNotificationResult(SubscriptionStatus status) {
        ...
        return "HTTP/1.1 200 OK\r\n" + "Date: " + (com.independentsoft.exchange.d.a(Calendar.getInstance().getTime()) + " GMT") + "\r\n" + "Connection: close\r\n" + "Content-Type: text/xml; charset=utf-8\r\n" + "Content-Length: " + Charset.forName("UTF-8").encode(string).limit() + "\r\n" + "\r\n" + string;
    }
    ...
    private SyncItemsResponse a(FolderId var1, ItemShape var2, String var3, final List<ItemId> var4, int var5, final SyncItemsScope var6) throws ServiceException {
        if (var1 == null) {
            ...
            try {
                ...
                if (var3 != null) {
                    var7 = var7 + "<SyncState>" + com.independentsoft.exchange.d.a(var3) + "</SyncState>";
                }
            ...
            if (var18.getResponseClass() == ResponseClass.ERROR) {
                String var21 = com.independentsoft.exchange.a.a(var18.getResponseCode());
    ...
    private SyncFoldersResponse a(FolderId a, FolderShape folderShape, String message) throws ServiceException {
        ...
        try {
            ...
            if (message != null) {
                requestBody = requestBody + "<SyncState>" + com.independentsoft.exchange.d.a(message) + "</SyncState>";
            }
            final String string;
        ...
        if ((response).getResponseClass() == ResponseClass.ERROR) {
            final String a2 = com.independentsoft.exchange.a.a((response).getResponseCode());
    ...
    private AvailabilityResponse a(List<MailboxData> a, final SerializableTimeZone serializableTimeZone, final FreeBusyViewOptions freeBusyViewOptions, final SuggestionsViewOptions suggestionsViewOptions) throws ServiceException {
        ...
        if ((response).getFreeBusyResponses().size() == 1 && (response).getFreeBusyResponses().get(0).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((response).getFreeBusyResponses().get(0).getResponseCode()), (response).getFreeBusyResponses().get(0).getMessage(), (response).getFreeBusyResponses().get(0).getXmlMessage(), s, (response).getFreeBusyResponses().get(0).getServerVersionInfo());
        }
        if ((response).getFreeBusyResponses().size() == 0 && (response).getSuggestionsResponse() != null && (response).getSuggestionsResponse().getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((response).getSuggestionsResponse().getResponseCode()), (response).getSuggestionsResponse().getMessage(), (response).getSuggestionsResponse().getXmlMessage(), s, (response).getSuggestionsResponse().getServerVersionInfo());
        }
        return response;
    }
    ...
    private FindMessageTrackingReportResponse a(MessageTrackingScope var1, String var2, final Mailbox var3, final Mailbox var4, final Mailbox var5, final String var6, final Date var7, final Date var8, final String var9, final Mailbox var10, final String var11) throws ServiceException {
        ...
        try {
            ...
            var12 = var12 + "<Scope>" + com.independentsoft.exchange.a.a(var1) + "</Scope>";
            if (var2 != null) {
                var12 = var12 + "<Domain>" + com.independentsoft.exchange.d.a(var2) + "</Domain>";
            }
            ...
            if (var6 != null) {
                var12 = var12 + "<Subject>" + com.independentsoft.exchange.d.a(var6) + "</Subject>";
            }

            if (var7 != null) {
                var12 = var12 + "<StartDateTime>" + com.independentsoft.exchange.d.a(var7) + "</StartDateTime>";
            }

            if (var8 != null) {
                var12 = var12 + "<EndDateTime>" + com.independentsoft.exchange.d.a(var8) + "</EndDateTime>";
            }

            if (var9 != null) {
                var12 = var12 + "<MessageId>" + com.independentsoft.exchange.d.a(var9) + "</MessageId>";
            }
            ...
            if (var11 != null) {
                var12 = var12 + "<DiagnosticsLevel>" + com.independentsoft.exchange.d.a(var11) + "</DiagnosticsLevel>";
            }
        ...
        if (var23.getResponseClass() == ResponseClass.ERROR) {
            var2 = com.independentsoft.exchange.a.a(var23.getResponseCode());
    ...
    private GetMessageTrackingReportResponse a(MessageTrackingScope a, final MessageTrackingReportTemplate messageTrackingReportTemplate, String message, final Mailbox mailbox, final boolean b, final String s) throws ServiceException {
        ...
        try {
            ...
            requestBody = requestBody + "<Scope>" + com.independentsoft.exchange.a.a(a) + "</Scope>";
            ...
            if (message != null) {
                requestBody = requestBody + "<MessageTrackingReportId>" + com.independentsoft.exchange.d.a(message) + "</MessageTrackingReportId>";
            }
            if (b) {
                requestBody += "<ReturnQueueEvents>true</ReturnQueueEvents>";
            }
            if (s != null) {
                requestBody = requestBody + "<DiagnosticsLevel>" + com.independentsoft.exchange.d.a(s) + "</DiagnosticsLevel>";
            }
            final String string;
    ...
    private GetServerTimeZonesResponse a(List<String> a, final boolean b) throws ServiceException {
        ...
        try {
            ...
            if (a != null && ((List)a).size() > 0) {
                requestBody += "<Ids>";
                for (int i = 0; i < ((List)a).size(); ++i) {
                    requestBody = requestBody + "<t:Id>" + com.independentsoft.exchange.d.a(((List<String>)a).get(i)) + "</t:Id>";
                }
                requestBody += "</Ids>";
            }
            final String string;
    ...
    private GetMailTipsResponse a(Mailbox var1, final List<Mailbox> var2, final MailTipType var3) throws ServiceException {
        ...
        if (var16.getResponseClass() == ResponseClass.ERROR) {
            String var20 = com.independentsoft.exchange.a.a(var16.getResponseCode());
    ...
    private GetSharingFolderResponse a(String var1, final SharingDataType var2, String var3) throws ServiceException {
        ...
        try {
            ...
            if (var1 != null) {
                var4 = var4 + "<SmtpAddress>" + com.independentsoft.exchange.d.a(var1) + "</SmtpAddress>";
            }
            ...
            if (var3 != null) {
                var4 = var4 + "<SharedFolderId>" + com.independentsoft.exchange.d.a(var3) + "</SharedFolderId>";
            }
        ...
        if (var16.getResponseClass() == ResponseClass.ERROR) {
            String var18 = com.independentsoft.exchange.a.a(var16.getResponseCode());
    ...
    private GetSharingMetadataResponse a(FolderId a, String responseCode, final List<String> list) throws ServiceException {
        ...
        try {
            ...
            if (responseCode != null) {
                requestBody = requestBody + "<SenderSmtpAddress>" + com.independentsoft.exchange.d.a(responseCode) + "</SenderSmtpAddress>";
            }
            if (list != null && list.size() > 0) {
                requestBody += "<Recipients>";
                for (int i = 0; i < list.size(); ++i) {
                    if (list.get(i) != null) {
                        requestBody = requestBody + "<t:SmtpAddress>" + com.independentsoft.exchange.d.a(list.get(i)) + "</t:SmtpAddress>";
                    }
                }
                requestBody += "</Recipients>";
            }
    ...
    private List<ConvertIdResponse> a(List<SourceId> o, final IdFormat idFormat) throws ServiceException {
        ...
        try {
            requestBody = "<ConvertId " + ("DestinationFormat=\"" + com.independentsoft.exchange.a.a(idFormat) + "\"") + " xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\" xmlns:t=\"http://schemas.microsoft.com/exchange/services/2006/types\">";
        ...
        if ((convertIdResponseList).size() == 1 && ((convertIdResponseList).get(0)).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(((convertIdResponseList).get(0)).getResponseCode()), ((convertIdResponseList).get(0)).getMessage(), ((convertIdResponseList).get(0)).getXmlMessage(), requestBody, ((convertIdResponseList).get(0)).getServerVersionInfo());
        }
    ...
    private RuleOperationResponse a(List<Rule> a, final List<Rule> list, final List<String> list2, String a2, final boolean b) throws ServiceException {
        ...
        try {
            ...
            if (a2 != null) {
                requestBody = requestBody + "<MailboxSmtpAddress>" + com.independentsoft.exchange.d.a(a2) + "</MailboxSmtpAddress>";
            }
            if (b) {
        ...
        if ((response).getResponseClass() == ResponseClass.ERROR) {
            a2 = com.independentsoft.exchange.a.a((response).getResponseCode());
    ...
    private GetDiscoverySearchConfigurationResponse a(String a, final boolean b, final boolean b2) throws ServiceException {
        ...
        try {
            ...
            if (a != null) {
                requestBody = requestBody + "<SearchId>" + com.independentsoft.exchange.d.a(a) + "</SearchId>";
            }
            if (b) {
    ...
    private GetSearchableMailboxesResponse b(String a, final boolean b) throws ServiceException {
        ...
        try {
            ...
            if (a != null) {
                requestBody = requestBody + "<SearchFilter>" + com.independentsoft.exchange.d.a(a) + "</SearchFilter>";
            }
            if (b) {
                requestBody += "<ExpandGroupMembership>true</ExpandGroupMembership>";
            }
    ...
    private SearchMailboxesResponse a(List<MailboxQuery> var1, final SearchResultType var2, final PreviewItemShape var3, final List<PropertyOrder> var4, final String var5, final boolean var6, final int var7, final String var8, final SearchPageDirection var9) throws ServiceException {
        ...
        if (var5 != null) {
            var10 = var10 + "<Language>" + com.independentsoft.exchange.d.a(var5) + "</Language>";
        }
        ...
        if (var8 != null) {
            var10 = var10 + "<PageItemReference>" + com.independentsoft.exchange.d.a(var8) + "</PageItemReference>";
        }

        if (var9 != SearchPageDirection.NONE) {
            var10 = var10 + "<PageDirection>" + com.independentsoft.exchange.a.a(var9) + "</PageDirection>";
        }
        ...
        if (var22.getResponseClass() == ResponseClass.ERROR) {
            String var26 = com.independentsoft.exchange.a.a(var22.getResponseCode());
    ...
    private GetNonIndexableItemDetailsResponse a(List<String> a, final int n, String xmlMessage, final SearchPageDirection searchPageDirection, final boolean b) throws ServiceException {
        ...
        try {
            ...
            if (a != null && ((List)a).size() > 0) {
                ...
                for (int i = 0; i < ((List)a).size(); ++i) {
                    requestBody = requestBody + "<t:LegacyDN>" + com.independentsoft.exchange.d.a(((List<String>)a).get(i)) + "</t:LegacyDN>";
                }
                requestBody += "</Mailboxes>";
            }
            if (n >= 0) {
            ...
            if (xmlMessage != null) {
                requestBody = requestBody + "<PageItemReference>" + com.independentsoft.exchange.d.a(xmlMessage) + "</PageItemReference>";
            }
            if (searchPageDirection != SearchPageDirection.NONE) {
                requestBody = requestBody + "<PageDirection>" + com.independentsoft.exchange.a.a(searchPageDirection) + "</PageDirection>";
            }
            if (b) {
    ...
    private GetRemindersResponse a(Date var1, final Date var2, final ReminderType var3, final int var4) throws ServiceException {
        ...
        try {
            ...
            if (var1 != null) {
                var5 = var5 + "<BeginTime>" + com.independentsoft.exchange.d.a(var1) + "</BeginTime>";
            }

            if (var2 != null) {
                var5 = var5 + "<EndTime>" + com.independentsoft.exchange.d.a(var2) + "</EndTime>";
            }
    ...
    private GetUserPhotoResponse a(String var1, final UserPhotoSizeType var2) throws ServiceException {
        ...
        try {
            ...
            var3 = var3 + "<Email>" + com.independentsoft.exchange.d.a(var1) + "</Email>";
    ...
    private Response g(String a) throws ServiceException {
        ...
        try {
            ...
            string = string + "<Manifest>" + com.independentsoft.exchange.d.a(a) + "</Manifest>";
            final String string2;
    ...
    private Response h(String a) throws ServiceException {
        ...
        try {
            ...
            string = string + "<ID>" + com.independentsoft.exchange.d.a(a) + "</ID>";
            final String string2;
    ...
    private Response a(String var1, final DisableReason var2) throws ServiceException {
        ...
        try {
            ...
            var3 = var3 + "<ID>" + com.independentsoft.exchange.d.a(var1) + "</ID>";
        ...
        if (var15.getResponseClass() == ResponseClass.ERROR) {
            String var17 = com.independentsoft.exchange.a.a(var15.getResponseCode());
    ...
    private HoldOnMailboxesInfo i(String a) throws ServiceException {
        ...
        try {
            ...
            if (a != null) {
                string = string + "<HoldId>" + com.independentsoft.exchange.d.a(a) + "</HoldId>";
            }
            final String string2;
        ...
        if ((holdOnMailboxesInfo).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((holdOnMailboxesInfo).getResponseCode()), (holdOnMailboxesInfo).getMessage(), (holdOnMailboxesInfo).getXmlMessage(), string, (holdOnMailboxesInfo).getServerVersionInfo());
        }
    ...
    private HoldOnMailboxesInfo a(HoldActionType a, String responseCode, String message, final List<String> list, final String s, final boolean b, final boolean b2, final String s2) throws ServiceException {
        ...
        try {
            ...
            if (responseCode != null) {
                requestBody = requestBody + "<HoldId>" + com.independentsoft.exchange.d.a(responseCode) + "</HoldId>";
            }
            if (message != null) {
                requestBody = requestBody + "<Query>" + com.independentsoft.exchange.d.a(message) + "</Query>";
            }
            if (list != null && list.size() > 0) {
                requestBody += "<Mailboxes>";
                for (int i = 0; i < list.size(); ++i) {
                    requestBody = requestBody + "<t:String>" + com.independentsoft.exchange.d.a(list.get(i)) + "</t:String>";
                }
                requestBody += "</Mailboxes>";
            }
            if (s != null) {
                requestBody = requestBody + "<Language>" + com.independentsoft.exchange.d.a(s) + "</Language>";
            }
            if (b) {
            ...
            if (s2 != null) {
                requestBody = requestBody + "<InPlaceHoldIdentity>" + com.independentsoft.exchange.d.a(s2) + "</InPlaceHoldIdentity>";
            }
        ...
        if ((holdOnMailboxesInfo).getResponseClass() == ResponseClass.ERROR) {
            responseCode = com.independentsoft.exchange.a.a((holdOnMailboxesInfo).getResponseCode());
    ...
    private List<ExportItemsResponse> e(List<ItemId> o) throws ServiceException {
        ...
        if ((exportItemsResponseList).size() == 1 && ((exportItemsResponseList).get(0)).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(((exportItemsResponseList).get(0)).getResponseCode()), ((exportItemsResponseList).get(0)).getMessage(), ((exportItemsResponseList).get(0)).getXmlMessage(), requestBody, ((exportItemsResponseList).get(0)).getServerVersionInfo());
        }
    ...
    private List<MarkAsJunkResponse> b(List<ItemId> var1, boolean var2, final boolean var3) throws ServiceException {
        ...
        if (markAsJunkResponseList.size() == 1 && (markAsJunkResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            String var18 = com.independentsoft.exchange.a.a((markAsJunkResponseList.get(0)).getResponseCode());
    ...
    private List<UploadItemsResponse> g(List<UploadItem> o) throws ServiceException {
        ...
        if ((uploadItemsResponseList).size() == 1 && (uploadItemsResponseList.get(0)).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(((uploadItemsResponseList).get(0)).getResponseCode()), ((uploadItemsResponseList).get(0)).getMessage(), ((uploadItemsResponseList).get(0)).getXmlMessage(), requestBody, ((uploadItemsResponseList).get(0)).getServerVersionInfo());
        }
            ...
            if (this.g == RequestServerVersion.EXCHANGE_2013 || this.g == RequestServerVersion.EXCHANGE_2013_SP1 || this.g == RequestServerVersion.EXCHANGE_2016) {
                if (queryString != null) {
                    if (mailboxSearchLocation != MailboxSearchLocation.NONE) {
                        requestBody = requestBody + "<MailboxScope>" + com.independentsoft.exchange.a.a(mailboxSearchLocation) + "</MailboxScope>";
                    }
    ...
    private FindMailboxStatisticsByKeywordsResponse a(MailboxStatisticsByKeywords a) throws ServiceException {
        ...
        if (findMailboxStatisticsByKeywordsResponse.getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a(findMailboxStatisticsByKeywordsResponse.getResponseCode()), findMailboxStatisticsByKeywordsResponse.getMessage(), findMailboxStatisticsByKeywordsResponse.getXmlMessage(), string, findMailboxStatisticsByKeywordsResponse.getServerVersionInfo());
        }
        return findMailboxStatisticsByKeywordsResponse;
    }
    
    public com.independentsoft.msg.Message getMessageFile(final String itemId) throws ServiceException, ParseException {
        return this.getMessageFile(new ItemId(itemId));
    }
    
    public com.independentsoft.msg.Message getMessageFile(final String itemId, final List<ExtendedPropertyPath> customPropertyPaths) throws ServiceException, ParseException {
        return this.getMessageFile(new ItemId(itemId), customPropertyPaths);
    }
    
    public com.independentsoft.msg.Message getMessageFile(final ItemId itemId) throws ServiceException, ParseException {
        return this.getMessageFile(itemId, new ArrayList<ExtendedPropertyPath>());
    }
    
    public com.independentsoft.msg.Message getMessageFile(final ItemId itemId, final List<ExtendedPropertyPath> customPropertyPaths) throws ServiceException, ParseException {
        return this.a(itemId, customPropertyPaths);
    }
    
    private com.independentsoft.msg.Message a(final ItemId itemId, final List<ExtendedPropertyPath> list) throws ServiceException, ParseException {
        ...
        final com.independentsoft.msg.Message message = new com.independentsoft.msg.Message();
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_RTF_COMPRESSED) != null && item.getExtendedProperty(MapiPropertyTag.PR_RTF_COMPRESSED).getValue() != null) {
            message.setRtfCompressed(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_RTF_COMPRESSED).getValue()));
        }
        if (item.getExtendedProperty(MapiPropertyTag.PR_SEARCH_KEY) != null && item.getExtendedProperty(MapiPropertyTag.PR_SEARCH_KEY).getValue() != null) {
            message.setSearchKey(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_SEARCH_KEY).getValue()));
        }
        if (item.getExtendedProperty(MapiPropertyTag.PR_ENTRYID) != null && item.getExtendedProperty(MapiPropertyTag.PR_ENTRYID).getValue() != null) {
            message.setEntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_ENTRYID).getValue()));
        }
        if (item.getExtendedProperty(MapiPropertyTag.PR_CREATION_TIME) != null && item.getExtendedProperty(MapiPropertyTag.PR_CREATION_TIME).getValue() != null) {
            message.setCreationTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(MapiPropertyTag.PR_CREATION_TIME).getValue()));
        }
        if (item.getExtendedProperty(MapiPropertyTag.PR_LAST_MODIFICATION_TIME) != null && item.getExtendedProperty(MapiPropertyTag.PR_LAST_MODIFICATION_TIME).getValue() != null) {
            message.setLastModificationTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(MapiPropertyTag.PR_LAST_MODIFICATION_TIME).getValue()));
        }
        if (item.getExtendedProperty(MapiPropertyTag.PR_MESSAGE_DELIVERY_TIME) != null && item.getExtendedProperty(MapiPropertyTag.PR_MESSAGE_DELIVERY_TIME).getValue() != null) {
            message.setMessageDeliveryTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(MapiPropertyTag.PR_MESSAGE_DELIVERY_TIME).getValue()));
        }
        if (item.getExtendedProperty(MapiPropertyTag.PR_CLIENT_SUBMIT_TIME) != null && item.getExtendedProperty(MapiPropertyTag.PR_CLIENT_SUBMIT_TIME).getValue() != null) {
            message.setClientSubmitTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(MapiPropertyTag.PR_CLIENT_SUBMIT_TIME).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_CONVERSATION_INDEX) != null && item.getExtendedProperty(MapiPropertyTag.PR_CONVERSATION_INDEX).getValue() != null) {
            message.setConversationIndex(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_CONVERSATION_INDEX).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_HTML) != null) {
            message.setBodyHtml(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_HTML).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_RCVD_REPRESENTING_ENTRYID) != null && item.getExtendedProperty(MapiPropertyTag.PR_RCVD_REPRESENTING_ENTRYID).getValue() != null) {
            message.setReceivedRepresentingEntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_RCVD_REPRESENTING_ENTRYID).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_RCVD_REPRESENTING_SEARCH_KEY) != null && item.getExtendedProperty(MapiPropertyTag.PR_RCVD_REPRESENTING_SEARCH_KEY).getValue() != null) {
            message.setReceivedRepresentingSearchKey(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_RCVD_REPRESENTING_SEARCH_KEY).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_RECEIVED_BY_ENTRYID) != null && item.getExtendedProperty(MapiPropertyTag.PR_RECEIVED_BY_ENTRYID).getValue() != null) {
            message.setReceivedByEntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_RECEIVED_BY_ENTRYID).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_RECEIVED_BY_SEARCH_KEY) != null && item.getExtendedProperty(MapiPropertyTag.PR_RECEIVED_BY_SEARCH_KEY).getValue() != null) {
            message.setReceivedBySearchKey(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_RECEIVED_BY_SEARCH_KEY).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_SENDER_ENTRYID) != null && item.getExtendedProperty(MapiPropertyTag.PR_SENDER_ENTRYID).getValue() != null) {
            message.setSenderEntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_SENDER_ENTRYID).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_SENDER_SEARCH_KEY) != null && item.getExtendedProperty(MapiPropertyTag.PR_SENDER_SEARCH_KEY).getValue() != null) {
            message.setSenderSearchKey(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_SENDER_SEARCH_KEY).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_SENT_REPRESENTING_ENTRYID) != null && item.getExtendedProperty(MapiPropertyTag.PR_SENT_REPRESENTING_ENTRYID).getValue() != null) {
            message.setSentRepresentingEntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_SENT_REPRESENTING_ENTRYID).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_SENT_REPRESENTING_SEARCH_KEY) != null && item.getExtendedProperty(MapiPropertyTag.PR_SENT_REPRESENTING_SEARCH_KEY).getValue() != null) {
            message.setSentRepresentingSearchKey(com.independentsoft.exchange.d.e(item.getExtendedProperty(MapiPropertyTag.PR_SENT_REPRESENTING_SEARCH_KEY).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_LAST_VERB_EXECUTION_TIME) != null && item.getExtendedProperty(MapiPropertyTag.PR_LAST_VERB_EXECUTION_TIME).getValue() != null) {
            message.setLastVerbExecutionTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(MapiPropertyTag.PR_LAST_VERB_EXECUTION_TIME).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyPath2) != null && item.getExtendedProperty(propertyPath2).getValue() != null) {
            message.setCommonStartTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath2).getValue()));
        }
        if (item.getExtendedProperty(propertyPath3) != null && item.getExtendedProperty(propertyPath3).getValue() != null) {
            message.setCommonEndTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath3).getValue()));
        }
        if (item.getExtendedProperty(propertyPath4) != null && item.getExtendedProperty(propertyPath4).getValue() != null) {
            message.setFlagDueBy(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath4).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyPath5) != null && item.getExtendedProperty(propertyPath5).getValue() != null) {
            message.setReminderTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath5).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyPath8) != null && item.getExtendedProperty(propertyPath8).getValue() != null) {
            message.setAppointmentStartTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath8).getValue()));
        }
        if (item.getExtendedProperty(propertyPath9) != null && item.getExtendedProperty(propertyPath9).getValue() != null) {
            message.setAppointmentEndTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath9).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyPath12) != null && item.getExtendedProperty(propertyPath12).getValue() != null) {
            message.setGuid(com.independentsoft.exchange.d.e(item.getExtendedProperty(propertyPath12).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyPath15) != null && item.getExtendedProperty(propertyPath15).getValue() != null) {
            message.setTaskStartDate(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath15).getValue()));
        }
        if (item.getExtendedProperty(propertyPath16) != null && item.getExtendedProperty(propertyPath16).getValue() != null) {
            message.setTaskDueDate(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath16).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyPath20) != null && item.getExtendedProperty(propertyPath20).getValue() != null) {
            message.setDateCompleted(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath20).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyPath25) != null && item.getExtendedProperty(propertyPath25).getValue() != null) {
            message.setJournalStartTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath25).getValue()));
        }
        if (item.getExtendedProperty(propertyPath26) != null && item.getExtendedProperty(propertyPath26).getValue() != null) {
            message.setJournalEndTime(com.independentsoft.exchange.d.c(item.getExtendedProperty(propertyPath26).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_BIRTHDAY) != null && item.getExtendedProperty(MapiPropertyTag.PR_BIRTHDAY).getValue() != null) {
            message.setBirthday(com.independentsoft.exchange.d.c(item.getExtendedProperty(MapiPropertyTag.PR_BIRTHDAY).getValue()));
        }
        ...
        if (item.getExtendedProperty(MapiPropertyTag.PR_WEDDING_ANNIVERSARY) != null) {
            message.setWeddingAnniversary(com.independentsoft.exchange.d.c(item.getExtendedProperty(MapiPropertyTag.PR_WEDDING_ANNIVERSARY).getValue()));
        }
        ...
        if (item.getExtendedProperty(propertyId43) != null) {
            message.setEmail1EntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(propertyId43).getValue()));
        }
        if (item.getExtendedProperty(propertyId44) != null) {
            message.setEmail2EntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(propertyId44).getValue()));
        }
        if (item.getExtendedProperty(propertyId45) != null) {
            message.setEmail3EntryId(com.independentsoft.exchange.d.e(item.getExtendedProperty(propertyId45).getValue()));
        }
        for (int j = 0; j < list.size(); ++j) {
            if (item.getExtendedProperty(list.get(j)) != null && item.getExtendedProperty(list.get(j)).getValue() != null) {
                if (list.get(j) instanceof PropertyId) {
                    ...
                    tag.setGuid(com.independentsoft.exchange.d.a(propertyId46.getSet()));
                    tag.setType(com.independentsoft.exchange.d.a(propertyId46.getType()));
                    if (propertyId46.getType() == MapiPropertyType.BOOLEAN) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag, Boolean.parseBoolean(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyId46.getType() == MapiPropertyType.SHORT) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag, Short.parseShort(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyId46.getType() == MapiPropertyType.INTEGER) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag, Integer.parseInt(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyId46.getType() == MapiPropertyType.LONG) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag, Long.parseLong(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyId46.getType() == MapiPropertyType.FLOAT || propertyId46.getType() == MapiPropertyType.DOUBLE) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag, Double.parseDouble(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyId46.getType() == MapiPropertyType.SYSTEM_TIME || propertyId46.getType() == MapiPropertyType.APPLICATION_TIME) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag, com.independentsoft.exchange.d.c(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag, item.getExtendedProperty(list.get(j)).getValue()));
                    }
                }
                    ...
                    tag2.setGuid(com.independentsoft.exchange.d.a(UUID.fromString(customPropertyId5.getSet())));
                    tag2.setType(com.independentsoft.exchange.d.a(customPropertyId5.getType()));
                    if (customPropertyId5.getType() == MapiPropertyType.BOOLEAN) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag2, Boolean.parseBoolean(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyId5.getType() == MapiPropertyType.SHORT) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag2, Short.parseShort(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyId5.getType() == MapiPropertyType.INTEGER) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag2, Integer.parseInt(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyId5.getType() == MapiPropertyType.LONG) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag2, Long.parseLong(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyId5.getType() == MapiPropertyType.FLOAT || customPropertyId5.getType() == MapiPropertyType.DOUBLE) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag2, Double.parseDouble(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                        ...
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag2, com.independentsoft.exchange.d.c(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag2, item.getExtendedProperty(list.get(j)).getValue()));
                    }
                }
                    ...
                    tag3.setGuid(com.independentsoft.exchange.d.a(propertyName.getSet()));
                    tag3.setType(com.independentsoft.exchange.d.a(propertyName.getType()));
                    if (propertyName.getType() == MapiPropertyType.BOOLEAN) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag3, Boolean.parseBoolean(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyName.getType() == MapiPropertyType.SHORT) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag3, Short.parseShort(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyName.getType() == MapiPropertyType.INTEGER) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag3, Integer.parseInt(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyName.getType() == MapiPropertyType.LONG) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag3, Long.parseLong(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyName.getType() == MapiPropertyType.FLOAT || propertyName.getType() == MapiPropertyType.DOUBLE) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag3, Double.parseDouble(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (propertyName.getType() == MapiPropertyType.SYSTEM_TIME || propertyName.getType() == MapiPropertyType.APPLICATION_TIME) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag3, com.independentsoft.exchange.d.c(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag3, item.getExtendedProperty(list.get(j)).getValue()));
                    }
                }
                    ...
                    tag4.setGuid(com.independentsoft.exchange.d.a(UUID.fromString(customPropertyName.getSet())));
                    tag4.setType(com.independentsoft.exchange.d.a(customPropertyName.getType()));
                    if (customPropertyName.getType() == MapiPropertyType.BOOLEAN) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag4, Boolean.parseBoolean(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyName.getType() == MapiPropertyType.SHORT) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag4, Short.parseShort(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyName.getType() == MapiPropertyType.INTEGER) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag4, Integer.parseInt(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyName.getType() == MapiPropertyType.LONG) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag4, Long.parseLong(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else if (customPropertyName.getType() == MapiPropertyType.FLOAT || customPropertyName.getType() == MapiPropertyType.DOUBLE) {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag4, Double.parseDouble(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                        ...
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag4, com.independentsoft.exchange.d.c(item.getExtendedProperty(list.get(j)).getValue())));
                    }
                    else {
                        message.getExtendedProperties().add(new com.independentsoft.msg.ExtendedProperty(tag4, item.getExtendedProperty(list.get(j)).getValue()));
                    }
                }
            }
        }
        if (!message.getMessageClass().equals("IPM.Activity") && !message.getMessageClass().equals("IPM.StickyNote") && item instanceof Message) {
            ...
            for (int k = 0; k < message2.getToRecipients().size(); ++k) {
                ...
                recipient.setEntryId(com.independentsoft.exchange.d.h(mailbox.getEmailAddress()));
            ...
            for (int l = 0; l < message2.getCcRecipients().size(); ++l) {
                ...
                recipient2.setEntryId(com.independentsoft.exchange.d.h(mailbox2.getEmailAddress()));
            ...
            for (int n = 0; n < message2.getBccRecipients().size(); ++n) {
                ...
                recipient3.setEntryId(com.independentsoft.exchange.d.h(mailbox3.getEmailAddress()));
            ...
            for (int n2 = 0; n2 < appointment.getRequiredAttendees().size(); ++n2) {
                ...
                if ((attendee = appointment.getRequiredAttendees().get(n2)) != null && attendee.getMailbox() != null) {
                    ...
                    recipient4.setEntryId(com.independentsoft.exchange.d.h(attendee.getMailbox().getEmailAddress()));
            ...
            for (int n3 = 0; n3 < appointment.getOptionalAttendees().size(); ++n3) {
                ...
                if ((attendee2 = appointment.getOptionalAttendees().get(n3)) != null && attendee2.getMailbox() != null) {
                    ...
                    recipient5.setEntryId(com.independentsoft.exchange.d.h(attendee2.getMailbox().getEmailAddress()));
            ...
            for (int n4 = 0; n4 < appointment.getResources().size(); ++n4) {
                ...
                if ((attendee3 = appointment.getResources().get(n4)) != null && attendee3.getMailbox() != null) {
                    ...
                    recipient6.setEntryId(com.independentsoft.exchange.d.h(attendee3.getMailbox().getEmailAddress()));
        ...
        if (item.getAttachments() != null && item.getAttachments().size() > 0) {
            ...
            for (int n6 = 0; n6 < attachments2.size(); ++n6) {
                if (attachments2.get(n6) instanceof FileAttachment) {
                    ...
                    final com.independentsoft.msg.Attachment attachment;
                    (attachment = new com.independentsoft.msg.Attachment()).setData(fileAttachment.getContent());
                    ...
                    if ((itemAttachment = (ItemAttachment)attachments2.get(n6)) != null && itemAttachment.getItem() != null && itemAttachment.getItem().getMimeContent() != null) {
                        ...
                        if (data != null) {
                            ...
                            final com.independentsoft.msg.Attachment attachment2;
                            (attachment2 = new com.independentsoft.msg.Attachment()).setData(data);
    ...
    public Response createRetentionSettings(final RetentionSettings retentionSettings, final FolderId folderId) throws ServiceException {
        ...
        (userConfiguration = new UserConfiguration(new UserConfigurationName("MRM", folderId))).setXmlData(com.independentsoft.exchange.d.a(com.independentsoft.exchange.d.d(retentionSettings.a())));
    ...
    public RetentionSettings getRetentionSettings(final FolderId folderId) throws ServiceException, XMLStreamException, ParseException {
        ...
        final byte[] e;
        if (userConfiguration.getUserConfiguration() != null && userConfiguration.getUserConfiguration().getXmlData() != null && (e = com.independentsoft.exchange.d.e(userConfiguration.getUserConfiguration().getXmlData())) != null) {
    ...
    public Response createCategoryList(final CategoryList categoryList, final FolderId folderId) throws ServiceException {
        final UserConfiguration userConfiguration;
        (userConfiguration = new UserConfiguration(new UserConfigurationName("CategoryList", folderId))).setXmlData(com.independentsoft.exchange.d.a(com.independentsoft.exchange.d.d(categoryList.a())));
        return this.createUserConfiguration(userConfiguration);
    }
    ...
    private CategoryList b(FolderId folderId) throws ServiceException {
        ...
        try {
            final byte[] e;
            if (userConfiguration.getUserConfiguration() != null && userConfiguration.getUserConfiguration().getXmlData() != null && userConfiguration.getUserConfiguration().getXmlData().length() > 0 && (e = com.independentsoft.exchange.d.e(userConfiguration.getUserConfiguration().getXmlData())) != null) {
                final XMLStreamReader xmlStreamReader = XMLInputFactory.newInstance().createXMLStreamReader(new ByteArrayInputStream(e));
                while (xmlStreamReader.hasNext() && xmlStreamReader.next() > 0) {
    ...
    private ImGroupInfoResponse j(String s) throws ServiceException {
        ...
        final String string = "<AddImGroup xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><DisplayName>" + com.independentsoft.exchange.d.a(s) + "</DisplayName></AddImGroup>";
        try {
    ...
    private Response a(ItemId a, String string) throws ServiceException {
        Response response;
        string = "<SetImGroup xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\">" + a.a("GroupId") + "<NewDisplayName>" + com.independentsoft.exchange.d.a(string) + "</NewDisplayName></SetImGroup>";
        try {
    ...
    private PersonaInfoResponse a(ItemId itemId, String a, String message, String xmlMessage) throws ServiceException {
        ...
        if (a != null) {
            s = s + "<TelUriAddress>" + com.independentsoft.exchange.d.a(a) + "</TelUriAddress>";
        }
        PersonaInfoResponse response;
        if (xmlMessage != null) {
            s = s + "<ImContactSipUriAddress>" + com.independentsoft.exchange.d.a(xmlMessage) + "</ImContactSipUriAddress>";
        }
        if (message != null) {
            s = s + "<ImTelephoneNumber>" + com.independentsoft.exchange.d.a(message) + "</ImTelephoneNumber>";
        }
        if (itemId != null) {
            s += itemId.a("GroupId");
        }
        ...
        if ((response).getResponseClass() == ResponseClass.ERROR) {
            a = com.independentsoft.exchange.a.a((response).getResponseCode());
            message = (response).getMessage();
            xmlMessage = (response).getXmlMessage();
    ...
    private ImGroupInfoResponse c(String s, String a) throws ServiceException {
        ...
        if (s != null) {
            s2 = s2 + "<SmtpAddress>" + com.independentsoft.exchange.d.a(s) + "</SmtpAddress>";
        }
        if (a != null) {
            s2 = s2 + "<DisplayName>" + com.independentsoft.exchange.d.a(a) + "</DisplayName>";
        }
    ...
    private PersonaInfoResponse a(ItemId itemId, String requestBody, String a) throws ServiceException {
        requestBody = "<AddNewImContactToGroup xmlns=\"http://schemas.microsoft.com/exchange/services/2006/messages\"><ImAddress>" + com.independentsoft.exchange.d.a(requestBody) + "</ImAddress>";
        if (a != null) {
            requestBody = requestBody + "<DisplayName>" + com.independentsoft.exchange.d.a(a) + "</DisplayName>";
        }
    ...
    private GetImItemListResponse a(ExtendedPropertyList list) throws ServiceException {
        ...
        if ((response).getResponseClass() == ResponseClass.ERROR) {
            throw new ServiceException(com.independentsoft.exchange.a.a((response).getResponseCode()), (response).getMessage(), (response).getXmlMessage(), string2, (response).getServerVersionInfo());
        }
        return response;
    }
