...
public class ConversationAction
{
    ...
    final String a() {
        ...
        if (this.d != null) {
            s = s + "<t:ConversationLastSyncTime>" + com.independentsoft.exchange.d.a(this.d) + "</t:ConversationLastSyncTime>";
        }
        if (this.e) {
        ...
        if (this.g != null && this.g.size() > 0) {
            ...
            for (int i = 0; i < this.g.size(); ++i) {
                if (this.g.get(i) != null) {
                    s2 = s2 + "<t:String>" + com.independentsoft.exchange.d.a(this.g.get(i)) + "</t:String>";
                }
            }
            s = s2 + "</t:Categories>";
        }
        ...
        if (this.j != DeleteType.NONE) {
            s = s + "<t:DeleteType>" + com.independentsoft.exchange.a.a(this.j) + "</t:DeleteType>";
        }
