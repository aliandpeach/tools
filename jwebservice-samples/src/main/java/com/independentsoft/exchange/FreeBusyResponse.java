...
{
    private FreeBusyView g;
    
    private FreeBusyResponse() {
    }
    
    FreeBusyResponse(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        ...
        while (reader.hasNext()) {
            ...
            else if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("FreeBusyView") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/messages")) {
                this.g = new FreeBusyView(reader);
            }
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("FreeBusyResponse") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/messages")) {
                break;
            }
            reader.next();
        }
