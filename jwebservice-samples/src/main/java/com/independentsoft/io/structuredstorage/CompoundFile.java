...
public class CompoundFile
{
    ...
    private byte[] a() throws IOException {
        ...
        long n = 4294967294L;
        long n2 = 0L;
        this.b.color = com.independentsoft.io.structuredstorage.a.a;
    ...
    private void a(DirectoryEntry directoryEntry, DirectoryEntryList list, final Date date) {
        while (directoryEntry.directoryEntries.size() > 0) {
            ...
            if (directoryEntry.color == com.independentsoft.io.structuredstorage.a.b) {
                directoryEntry2.color = com.independentsoft.io.structuredstorage.a.a;
            }
            else {
                directoryEntry2.color = com.independentsoft.io.structuredstorage.a.b;
            }
            ...
            for (int i = n - 1; i >= 0; --i) {
                ...
                if (directoryEntry.color == com.independentsoft.io.structuredstorage.a.b) {
                    directoryEntry5.color = com.independentsoft.io.structuredstorage.a.a;
                }
                else {
                    directoryEntry5.color = com.independentsoft.io.structuredstorage.a.b;
                }
            ...
            for (int j = n + 1; j < directoryEntry.directoryEntries.size(); ++j) {
                ...
                if (directoryEntry.color == com.independentsoft.io.structuredstorage.a.b) {
                    directoryEntry8.color = com.independentsoft.io.structuredstorage.a.a;
                }
                else {
                    directoryEntry8.color = com.independentsoft.io.structuredstorage.a.b;
                }
