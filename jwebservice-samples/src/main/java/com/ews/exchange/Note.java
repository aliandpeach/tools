...
public class Note extends Item
{
    ...
    final String a() {
        ...
        if (this.ah != NoteColor.NONE) {
            s += new ExtendedProperty(NotePropertyPath.COLOR, com.ews.exchange.a.a(this.ah)).toString();
        }
        if (this.ai.size() > 0) {
            s += new ExtendedProperty(NotePropertyPath.CONTACTS, this.ai).toString();
        }
        if (this.aj != NoteColor.NONE) {
            s += new ExtendedProperty(MapiPropertyTag.PR_ACTION, Integer.parseInt(com.ews.exchange.a.a(this.aj)) + 768).toString();
        }
