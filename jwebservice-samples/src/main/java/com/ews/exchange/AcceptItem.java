...
public class AcceptItem extends MeetingRegistrationResponse
{
    ...
    public AcceptItem(final ItemId referenceItemId) {
        this.aw = referenceItemId;
    }
    
    AcceptItem(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("AcceptItem") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
