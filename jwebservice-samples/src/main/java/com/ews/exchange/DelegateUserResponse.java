...
{
    private DelegateUser g;
    
    private DelegateUserResponse() {
    }
    
    DelegateUserResponse(final XMLStreamReader reader) throws XMLStreamException {
        ...
        while (reader.hasNext()) {
            ...
            else if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("DelegateUser") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/messages")) {
                this.g = new DelegateUser(reader);
            }
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("DelegateUserResponseMessageType") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/messages")) {
                break;
            }
            reader.next();
        }
