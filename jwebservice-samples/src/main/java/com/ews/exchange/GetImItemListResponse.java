...
public class GetImItemListResponse extends Response
{
    ...
    GetImItemListResponse(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        this.g = new ArrayList<ImGroup>();
        this.h = new ArrayList<Persona>();
        this.a(reader);
    }
    ...
    private void a(final XMLStreamReader xmlStreamReader) throws XMLStreamException, ParseException {
        ...
        while (xmlStreamReader.hasNext()) {
            ...
            if (xmlStreamReader.isEndElement() && xmlStreamReader.getLocalName() != null && xmlStreamReader.getNamespaceURI() != null && xmlStreamReader.getLocalName().equals("GetImItemListResponse") && xmlStreamReader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/messages")) {
                break;
            }
            xmlStreamReader.next();
        }
