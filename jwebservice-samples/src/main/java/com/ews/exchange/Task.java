...
public class Task extends Item
{
        ...
        while (reader.hasNext()) {
            if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ItemId") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText10 = reader.getElementText()) != null && elementText10.length() > 0) {
                    this.an = com.ews.exchange.d.c(elementText10);
                }
            }
                ...
                if ((elementText12 = reader.getElementText()) != null && elementText12.length() > 0) {
                    this.ar = com.ews.exchange.d.c(elementText12);
                }
            }
                ...
                if ((elementText14 = reader.getElementText()) != null && elementText14.length() > 0) {
                    this.av = com.ews.exchange.d.c(elementText14);
                }
            }
                ...
                if ((elementText19 = reader.getElementText()) != null && elementText19.length() > 0) {
                    this.aE = com.ews.exchange.d.c(elementText19);
                }
            }
                ...
                if ((elementText23 = reader.getElementText()) != null && elementText23.length() > 0) {
                    this.s = com.ews.exchange.d.c(elementText23);
                }
            }
                ...
                if ((elementText24 = reader.getElementText()) != null && elementText24.length() > 0) {
                    this.N = com.ews.exchange.a.C(elementText24);
                }
            }
                ...
                if ((elementText25 = reader.getElementText()) != null && elementText25.length() > 0) {
                    this.O = com.ews.exchange.a.C(elementText25);
                }
            }
                ...
                if ((elementText28 = reader.getElementText()) != null && elementText28.length() > 0) {
                    this.S = com.ews.exchange.a.D(elementText28);
                }
            }
                ...
                if ((extendedProperty = new ExtendedProperty(reader)).getPropertyPath() instanceof PropertyTag) {
                    ...
                    if ((propertyTag = (PropertyTag)extendedProperty.getPropertyPath()).getTag() == MapiPropertyTag.PR_DISPLAY_NAME.getTag() && propertyTag.getType() == MapiPropertyTag.PR_DISPLAY_NAME.getType()) {
                        ...
                        this.aP = com.ews.exchange.a.M(extendedProperty.getValue());
                    }
                }
                    ...
                    if ((propertyId = (PropertyId)extendedProperty.getPropertyPath()).getId() == 34054 && propertyId.getSet() == StandardPropertySet.COMMON && propertyId.getType() == MapiPropertyType.BOOLEAN) {
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.aJ = com.ews.exchange.d.c(extendedProperty.getValue());
                        }
                    }
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.aK = com.ews.exchange.d.c(extendedProperty.getValue());
                        }
                    }
                        ...
                        if (extendedProperty.getValue() != null && extendedProperty.getValue().length() > 0) {
                            this.aO = com.ews.exchange.d.c(extendedProperty.getValue());
                        }
                    }
    ...
    final String a() {
        ...
        if (this.aN != null) {
            s3 += new ExtendedProperty(TaskPropertyPath.REMINDER_SOUND_FILE, com.ews.exchange.d.a(this.aN)).toString();
        }
        if (this.aB != null) {
            s3 += new ExtendedProperty(TaskPropertyPath.OWNER, com.ews.exchange.d.a(this.aB)).toString();
        }
        if (this.az) {
        ...
        if (this.ao != null) {
            s3 = s3 + "<t:BillingInformation>" + com.ews.exchange.d.a(this.ao) + "</t:BillingInformation>";
        }
        if (this.aq.size() > 0) {
            String s4 = s3 + "<t:Companies>";
            for (int k = 0; k < this.aq.size(); ++k) {
                if (this.aq.get(k) != null) {
                    s4 = s4 + "<t:String>" + com.ews.exchange.d.a(this.aq.get(k)) + "</t:String>";
                }
            }
            s3 = s4 + "</t:Companies>";
        }
        if (this.ar != null) {
            s3 = s3 + "<t:CompleteDate>" + com.ews.exchange.d.a(this.ar) + "</t:CompleteDate>";
        }
        if (this.as.size() > 0) {
            String s5 = s3 + "<t:Contacts>";
            for (int l = 0; l < this.as.size(); ++l) {
                if (this.as.get(l) != null) {
                    s5 = s5 + "<t:String>" + com.ews.exchange.d.a(this.as.get(l)) + "</t:String>";
                }
            }
            s3 = s5 + "</t:Contacts>";
        }
        if (this.av != null) {
            s3 = s3 + "<t:DueDate>" + com.ews.exchange.d.a(this.av) + "</t:DueDate>";
        }
        if (this.aA != null) {
            s3 = s3 + "<t:Mileage>" + com.ews.exchange.d.a(this.aA) + "</t:Mileage>";
        }
        if (this.aC > 0.0) {
        ...
        if (this.aE != null) {
            s3 = s3 + "<t:StartDate>" + com.ews.exchange.d.a(this.aE) + "</t:StartDate>";
        }
        if (this.aF != TaskStatus.NONE) {
            s3 = s3 + "<t:Status>" + com.ews.exchange.a.a(this.aF) + "</t:Status>";
        }
        if (this.aH > 0) {
