...
public class Identity
{
    ...
    final String a() {
        ...
        if (this.a != null) {
            s = s + "<t:PrincipalName>" + com.ews.exchange.d.a(this.a) + "</t:PrincipalName>";
        }
        if (this.b != null) {
            s = s + "<t:SID>" + com.ews.exchange.d.a(this.b) + "</t:SID>";
        }
        if (this.c != null) {
            s = s + "<t:PrimarySmtpAddress>" + com.ews.exchange.d.a(this.c) + "</t:PrimarySmtpAddress>";
        }
        if (this.d != null) {
            s = s + "<t:SmtpAddress>" + com.ews.exchange.d.a(this.d) + "</t:SmtpAddress>";
        }
