...
public class Post extends Item
{
    ...
    Post(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("ItemId") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText9 = reader.getElementText()) != null && elementText9.length() > 0) {
                    this.aq = Boolean.parseBoolean(elementText9);
                }
            }
            else if (reader.isStartElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("PostedTime") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                ...
                if ((elementText12 = reader.getElementText()) != null && elementText12.length() > 0) {
                    this.s = com.ews.exchange.d.c(elementText12);
                }
            }
                ...
                if ((elementText13 = reader.getElementText()) != null && elementText13.length() > 0) {
                    this.N = com.ews.exchange.a.C(elementText13);
                }
            }
                ...
                if ((elementText14 = reader.getElementText()) != null && elementText14.length() > 0) {
                    this.O = com.ews.exchange.a.C(elementText14);
                }
            }
                ...
                if ((elementText17 = reader.getElementText()) != null && elementText17.length() > 0) {
                    this.S = com.ews.exchange.a.D(elementText17);
                }
            }
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("PostItem") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
    ...
    final String a() {
        ...
        if (this.ao != null) {
            s = s + "<t:From>" + this.ao.a("t:Mailbox") + "</t:From>";
        }
        if (this.aq) {
            s += "<t:IsRead>true</t:IsRead>";
        }
        if (this.as != null) {
            s = s + "<t:References>" + com.ews.exchange.d.a(this.as) + "</t:References>";
        }
        if (this.at != null) {
            s = s + "<t:Sender>" + this.at.a("t:Mailbox") + "</t:Sender>";
        }
        return s + "</t:PostItem>";
    }
