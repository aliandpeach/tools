...
public class TasksFolder extends Folder
{
    ...
    public TasksFolder(final String displayName) {
        this.d = displayName;
    }
    
    public TasksFolder(final String displayName, final String folderClass) {
        this.d = displayName;
        this.c = folderClass;
    }
    
    TasksFolder(final XMLStreamReader reader) throws XMLStreamException, ParseException {
        while (reader.hasNext()) {
            ...
            if (reader.isEndElement() && reader.getLocalName() != null && reader.getNamespaceURI() != null && reader.getLocalName().equals("TasksFolder") && reader.getNamespaceURI().equals("http://schemas.microsoft.com/exchange/services/2006/types")) {
                break;
            }
            reader.next();
        }
