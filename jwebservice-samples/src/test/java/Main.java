...
public class Main
{
    public static void main(String[] args)
    {
        try
        {
            ...
            com.independentsoft.exchange.FindFolderResponse findFolderResponse1 = service.findFolder(StandardFolder.ROOT);
            com.independentsoft.exchange.FindFolderResponse findFolderResponse2 = service.findFolder(StandardFolder.PUBLIC_FOLDERS_ROOT);
