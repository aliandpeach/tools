...
public class DetailPanel extends JPanel
{
    ...
    private MyIconButton previousBtn;
    private MyIconButton nextBtn;
...
//        labelPanel.setBorder(new LineBorder(Color.BLACK));
        ...
        previousBtn = new MyIconButton(UiConsts.ICON_PREVIOUS, UiConsts.ICON_PREVIOUS, UiConsts.ICON_PREVIOUS, "");
        nextBtn = new MyIconButton(UiConsts.ICON_NEXT, UiConsts.ICON_NEXT, UiConsts.ICON_NEXT, "");
        closeBtn = new MyIconButton(UiConsts.ICON_CLOSE, UiConsts.ICON_CLOSE, UiConsts.ICON_CLOSE, "");
        btnPreviousPanel.add(previousBtn);
        btnNextPanel.add(nextBtn);
    ...
    {
        previousBtn.addMouseListener(new MouseListener()
        {
            @Override
            public void mouseClicked(MouseEvent e)
            {
                currentPos = scrollPane.getVerticalScrollBar().getValue();
                scrollPane.getVerticalScrollBar().setValue(currentPos = (Math.max((currentPos - 25), 0)));
                System.out.println("getMaximum " + scrollPane.getVerticalScrollBar().getMaximum()
                        + ",getMinimum " + scrollPane.getVerticalScrollBar().getMinimum()
                        + ",getValue " + scrollPane.getVerticalScrollBar().getValue());
            }
            ...
            {
                previousBtn.setCursor(Cursor.getDefaultCursor());
            }
        });
        nextBtn.addMouseListener(new MouseListener()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                System.out.println("scrollPanel height " + scrollPane.getHeight());
                currentPos = scrollPane.getVerticalScrollBar().getValue();
                scrollPane.getVerticalScrollBar().setValue(currentPos = (Math.min((currentPos + 25), scrollPane.getVerticalScrollBar().getMaximum() - 480)));
                System.out.println("getMaximum " + scrollPane.getVerticalScrollBar().getMaximum()
                        + ",getMinimum " + scrollPane.getVerticalScrollBar().getMinimum()
                        + ",getValue " + scrollPane.getVerticalScrollBar().getValue());
            }
            ...
            public void mouseExited(MouseEvent e)
            {
                nextBtn.setCursor(Cursor.getDefaultCursor());
            }
        });
